...
<!--<audio src="--><?//=BASE_URL?><!--/public/bg_music/haranoyori.mp3" loop="1" autoplay="1"></audio>-->
      ...
      <center><div class="modal-content">
              ...
              <div class="sign_in_form">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="暂不支持异空间用户">
                  </div>
                  <div class="input-group">
              ...
              <div class="modal-footer">
                 <center><button type="button" class="btn btn-default">确认注册</button></center>
              </div>
          </div></center>
        </div>
    </div>
