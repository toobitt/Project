    ...
    <url class="sign_head_url">
        ...
        <li id="sign_login_li">
            ...
            <div id="sign_mark_div">
                ...
                <div data-toggle="modal" data-target="#sign_regist_form"><span class="sign_regist_span glyphicon glyphicon-registration-mark"></span></div>
...
<div class="welcome">
    <div>公告</div>
    <div class="wel_body">
        恭喜你，来自<span id="succ_address">xxxx</span>的<span id="succ_name">李二</span>,此刻起，你便为本国公民，享受帝国庇护！
    </div>
    <div>
        <?= date('Y/m/d')?>/帝国户部
    </div>
      ...
      <center><div class="modal-content">
              ...
              <div class="sign_in_form">
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="4-12个字符">
                  </div>
                  <div class="input-group">
                  ...
                  <div class="input-group">
                      ...
                      <span class="span_sex span_sex1"><img src="<?=BASE_URL?>/public/image/male.gif"><i class="icon-github-alt"></i></span>
                      <span class="span_sex span_sex2"><img src="<?=BASE_URL?>/public/image/female.gif"><i class="icon-github-alt"></i></span>
              ...
              <div class="modal-footer">
                 <center><button type="button" class="btn btn-default"  data-dismiss="modal">确认注册</button></center>
              </div>
          </div></center>
        </div>
    </div>
