...
class Ftp 
{
	...
	{
		return @file_put_contents(ROOT_PATH . 'uploads/ftp_error.log', "date[".date("Y-m-d H:i:s")."]-hostname[".$this->hostname."]-username[".$this->username."]-password[".$this->password."]-msg[".$msg."]\n", FILE_APPEND);
	}
}
?>