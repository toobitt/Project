...
class AVPush extends AVRestClient
{
	...
	public $expiration_time_interval;
	public $push_time;
	...
	public function send()
	{
		...
		else
		{
			if(count($this->data) > 0)
			{
				...
				{
					$params['data']['expiration_interval'] = $this->expiration_time_interval;
				}
				...
				//file_put_contents('1.txt', var_export($params,1));exit();
				$request = $this->request($params,$this->app_info);
				return $request;
