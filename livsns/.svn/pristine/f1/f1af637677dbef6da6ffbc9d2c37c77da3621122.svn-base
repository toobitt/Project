...
*
* $Id: global.php 1743 2011-01-13 10:17:46Z chengqing $
***************************************************************************/
...
if(CHECK_LOCATION && $gUser['id'])
{
	if(!$gUser['group_id'] && SCRIPTNAME != 'geoinfo')
	{
		header('Location:geoinfo.php');
	}
}
