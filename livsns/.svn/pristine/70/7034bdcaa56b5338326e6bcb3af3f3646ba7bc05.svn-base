...
class GetPinyinByChinese
{
	...
	public function Pinyin($_String, $_Code='UTF8')
	{
        ...
        for($i=0; $i<strlen($_String); $i++) { 
                ...
                $str =  preg_replace("/[^a-z0-9]*/", '', $this->_Pinyin($_P, $_Data));
                $initials .= $str[0];
                	
        } 
       
        $ret = array($_String,preg_replace("/[^a-z0-9]*/", '', $_Res),$initials);
        return $ret;
	}
