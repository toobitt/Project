...
<div class="garea">
    ...
    <div class="g_are4 clear" id="content">
		...
		<div class="content-left">
					...
					<li class="clear">
						<div class="blog-content">
							...
							<div class="attention clear">
								<p class="name"><a href="<?php echo hg_build_link(SNS_UCENTER . 'user.php' , array('user_id' => $v['user_id']));?>" ><?php echo hg_cutchars($v['web_station_name'],7," "); ?></a><span style="margin-left:100px;"><a><?php echo $v['collect_count']; ?></a>收藏</span><span style="margin-left:50px;"><a><?php echo $v['comment_count']; ?></a>评论</span><span style="margin-left:50px;"><a><?php echo $v['click_count']; ?></a>访问</span></p>
								<span style="display:inline-block;margin-top:10px;">简介：<?php echo $v['brief']; ?></span>
							</div>
						
						</div>						
						<a href="<?php echo hg_build_link(SNS_UCENTER . 'user.php' , array('user_id' => $v['user_id']));?>"><img width="100px" src="<?php echo $v['small']; ?>" title="<?php echo $v['web_station_name']; ?>" /></a>											
					</li>		
				<?php 	
				} 		
				?>
			...
			{
			?>
			<p class="no-result"><?php echo hg_show_null(' ',"暂未关注任何频道！",1); ?></p>
			<?php	
			} 	
			?>
			</div>		
