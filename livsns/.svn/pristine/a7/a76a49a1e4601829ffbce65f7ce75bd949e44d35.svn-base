...
class control extends adminbase {
	...
	*/
	...
	function onregister() {
		$updated = false;
		if(getgpc('submitcheck', 'P')) {//$this->submitcheck()
			$this->set_setting('doublee', urldecode(getgpc('doublee', 'P')));
			$this->set_setting('accessemail', urldecode(getgpc('accessemail', 'P')));
			$this->set_setting('censoremail', urldecode(getgpc('censoremail', 'P')));
			$this->set_setting('censorusername', urldecode(getgpc('censorusername', 'P')));
			$updated = true;
	...
	function onmail() {
		...
		{
			$this->set_setting('maildefault', urldecode(getgpc('maildefault', 'P')));
			$this->set_setting('mailsend', urldecode(getgpc('mailsend', 'P')));
				$this->set_setting('mailserver', urldecode(getgpc('mailserver', 'P')));
				$this->set_setting('mailport', urldecode(getgpc('mailport', 'P')));
				$this->set_setting('mailauth', urldecode(getgpc('mailauth', 'P')));
				$this->set_setting('mailfrom', urldecode(getgpc('mailfrom', 'P')));
				$this->set_setting('mailauth_username', urldecode(getgpc('mailauth_username', 'P')));
				$this->set_setting('mailauth_password', urldecode(getgpc('mailauth_password', 'P')));
			$this->set_setting('maildelimiter', urldecode(getgpc('maildelimiter', 'P')));
			$this->set_setting('mailusername', urldecode(getgpc('mailusername', 'P')));
			$this->set_setting('mailsilent', urldecode(getgpc('mailsilent', 'P')));
			$updated = true;
			$this->writelog('setting_mail_update');
			$this->updatecache();
		}
