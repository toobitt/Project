<?php
/* $Id: follow.tpl.php 3235 2011-03-31 05:23:38Z chengqing $ */
?>
    ...
    <div class="g_are4 clear" id="content">
		...
		<div class="content-left">
			...
			<div class="my-business">
				...
				<div class="left">我关注了<span id="liv_title_followers_count" ><?php echo $user_info['attention_count']; ?></span>个人</div>
			...
			{ 		
			?>
			<div class="my-business"><div class="left"><?php echo $user_info['username'];?>关注了<span><?php echo $user_info['attention_count']; ?></span>个人</div></div>	
			<?php
			}
			?>
				...
				?>	
					<li class="clear" id="<?php echo 'delete_' . $v['id']; ?>">
						<div class="blog-content">
							...
							?>
							<a class="close-follow-a"  href="javascript:void(0);" onclick="moveFollow(<?php echo $v['id']; ?>)"></a>
							<?php
							}
							else
							{							
								if($this->user['id'] == $v['id']) 	 //别人关注中含有自己
								{
									//没有任何操作
								}
								else
							...
							<div id="<?php echo 'deleteFollow_' . $v['id']; ?>" class="followers-box4"></div>
						</div>		
			...
			{ 	
			?>
			<p class="no-result"><?php echo hg_show_null('真不给力，SORRY!','该用户还没有关注任何人！'); ?></p>
			<?php
			}
			?>
			</div>
