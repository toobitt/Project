...
$gGlobalConfig['data_url'] =  array (
  'path' => 'http://app.city.hogesoft.com/data/',
  'file' => 
  array (
    'content' => 
    array (
...
define('REPLACE_IMG_DOMAIN', '');

define('IS_REPLACE', 0);

define('WEATHER_API', 'http://weather.dingdone.com/');

define('MODULE_LIMIT_NUM', 1000);

define('STATISTICS_API', 'http://dd.liv.cn/');
