...
class media_channel_vod_m_vod extends BaseFrm
{
	public $field = 'id,expand_id,content_fromid,title,brief,video_order_id,channel_id,img,bitrate,vod_sort_id,status,author,user_id,addperson,source,starttime,delay_time,height,start,duration,width,vodid,type,transize,totalsize,audit,create_time,update_time,ip,vod_leixing,aspect,vtype,from_appid,from_appname,server,weight,outlink';

	public $tablename = 'liv_media_channel_vod_m_vod';
...
$out = new media_channel_vod_m_vod();
$action = $_INPUT['a'];
