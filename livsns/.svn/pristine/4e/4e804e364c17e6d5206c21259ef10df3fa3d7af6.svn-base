...
class livmedia_vod_vod extends adminBase
{
	public $field = 'id,expand_id,content_fromid,title,brief,video_order_id,channel_id,img,bitrate,vod_sort_id,status,author,user_id,addperson,source,starttime,delay_time,height,start,duration,width,vodid,keywords,catalog,type,transize,totalsize,audit,create_time,update_time,ip,vod_leixing,aspect,vtype,from_appid,from_appname,server,hostwork,video_path,video_filename,weight,outlink,right_info';

	public $tablename = 'livmedia_vod_vod';
	
	public $child_tablename = '';
	
	public $child_table = '';
	
	public $array_field = 'img_info,collects';
