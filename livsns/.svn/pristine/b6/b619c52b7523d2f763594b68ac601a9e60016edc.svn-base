...
class news_news_m_article_material extends BaseFrm
{
	public $field = 'id,cid,expand_id,content_fromid,material_id,name,pic_host,pic_dir,pic_filepath,pic_filename,type,imgwidth,imgheight,filesize,isdel,create_time,ip,remote_url,title,brief';

	public $tablename = 'liv_news_news_m_article_material';
	...
	public function get_content($child_condition = array())
	{
		$condition = '';
...
$out = new news_news_m_article_material();
$action = $_INPUT['a'];
