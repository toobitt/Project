...
class roadUpdateApi extends adminUpdateBase
{
	...
	public function create()
	{
		...
		$data = array(
			"act_name" 				=> $this->input["act_name"] ?  $this->input["act_name"] : '',		
			"act_date" 				=> $this->input["act_date"] ?  $this->input["act_date"] : '',		
			"host" 					=> $this->input["host"] ?  $this->input["host"] : '',
			"fee" 					=> $this->input["fee"] ?  $this->input["fee"] : '',
