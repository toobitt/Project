...
class liv_magazine_magazine_magazine_issue extends adminBase
{
	public $field = 'id,title,magazine_id,pub_date,state,top,recommend,ip,user_id,user_name,create_time,update_time,host,dir,file_name,file_path,file_type,
	...
	public $tablename = 'liv_magazine_magazine_magazine_issue';
	
	public $child_tablename = 'liv_magazine_magazine_magazine_issue_article';
	
	public $child_table = 'article';
	
	public $array_field = 'indexpic';
	
	public $array_child_field = 'indexpic';
...
$out = new liv_magazine_magazine_magazine_issue();
$action = $_INPUT['a'];
