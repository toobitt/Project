...
<p class="info0">亲爱的 <span class="red"><?php echo $this->user['username'];?></span>，就差一步了，快去激活您的帐号吧！</p>
<p>葫芦网往您的邮箱:<span class="el"><?php echo $this->user['email'];?></span>发了一封激活帐号信，请到邮箱中收信激活。</p>
<p>激活了帐号才能使用葫芦网所有的服务 。 <a href="<?php echo $goto;?>" id="goto" target="_blank">>>进入邮箱进行验证</a></p>
...
<div style="top: 30%; left: 20%; display: none; visibility: visible; position: absolute; z-index: 1000;" class="lightbox" id="pub_to_g">
	...
	<p >您目前收激活帐户信的邮箱地址为：</p>
	<p><span class="el"><?php echo $this->user['email'];?></span></p>
	<div class="input">
