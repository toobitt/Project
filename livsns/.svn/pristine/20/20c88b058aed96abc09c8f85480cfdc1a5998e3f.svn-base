<?php
define('MOD_UNIQUEID','message_sort');
require('global.php');
require_once(ROOT_PATH . 'frm/node_frm.php');
class message_node extends nodeFrm
{
	public function __construct()
	{
		parent::__construct();
		$this->setNodeTable('message_node');
		$this->setNodeVar('message_sort');
	}
	...
	public function show()
	{
		...
		/*if ($this->settings['App_publishcontent'])
		{
			$column = array(
				...
				'is_last' => 0,
				'id' => 0,
				'input_bundle' => 'mod_uniqueid=column&app_uniqueid',
				'bundle' => 'publishcontent'
			);
			$this->addItem($column);
		}*/
