...
class {$tablename} extends adminBase
{
	public $field = '{$field}';

	public $tablename = '{$tablename}';
	
	public $child_tablename = '{$child_tablename}';
	
	public $child_table = '{$child_table}';
	
	public $array_field = '{$array_field}';
	
	public $array_child_field = '{$array_child_field}';
