<?php
include_once (CUR_CONF_PATH . 'lib/Iexcel.php');
/**
...
class XmlExcel implements IExcel
{
    ...
    private $align_bold="<Style ss:ID=\"s65\"><Alignment ss:Horizontal=\"Center\" ss:Vertical=\"Center\"/><Font ss:FontName=\"宋体\" x:CharSet=\"134\" ss:Size=\"14\" ss:Color=\"#000000\" ss:Bold=\"1\"/></Style>";
