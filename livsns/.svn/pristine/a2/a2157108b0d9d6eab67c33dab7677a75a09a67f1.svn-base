 ...
 */
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/BCGBarcode.php');
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/drawer/BCGDrawJPG.php');
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/drawer/BCGDrawPNG.php');
