 ...
 */
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/BCGColor.php');
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/BCGLabel.php');
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/BCGArgumentException.php');
include_once(CUR_CONF_PATH . 'lib/barcodegen/class/BCGDrawException.php');
