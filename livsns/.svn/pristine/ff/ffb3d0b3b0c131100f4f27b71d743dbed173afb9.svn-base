$(document).ready(function (){
	...
	scaleVideo = function(sid,mid,self){
		...
		var url = $('#vu_'+id).html();
		var ids = "vo_" + id;
		var div = '<div class="pad_sp"><a href="javascript:void(0);" onclick="upvideo('+ sid +');">收起</a><a style="padding-left: 5px;" href="'+ url +'" target="_blank">'+ title +'</a><a style="padding-left: 5px;" href="javascript:void(0);" onclick="popvideo('+ sid +','+ mid +');">弹出</a></div>';
		$('#v_'+sid).show();
