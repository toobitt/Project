<?php
define('SCRIPT_NAME', 'verify_node');
define('MOD_UNIQUEID', 'verify_node');
require_once('global.php');
require_once ROOT_PATH . 'frm/node_frm.php';
class verify_node extends nodeFrm
{
	public function __construct()
	{
		parent::__construct();
		$this->setNodeTable('verify_node');
		$this->setNodeVar('verify_node');
	}
