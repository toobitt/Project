...
<div class="site_head_top">
	<div class="head_menu">
		...
		<div class="menu_mids">
			<form action="k.php" method="post" id='form'>
        	  <input id="head_search" type="text" name="q" onkeyup="show_head_search(this.value)" onfocus="add_search()" class="sea_name" value="输入关键字搜索..." onclick="javascript:if(this.value == '输入关键字搜索...'){this.value = '';}" onblur="javascript:if(!this.value){this.value='输入关键字搜索...';}">
