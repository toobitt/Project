...
define('NO_CORNER_CREATE', '0x1000093');//还未创建新角标 
define('NO_COMPONENTS_ID','0x1000094');//没有组件id
define('APP_IS_SUBMITED', '0x1000095');
define('NO_EXTEND_AREA_TYPE','0x1000096');//没有扩展区域类型
define('EXTEND_LINE_NUM_MAX','0x1000097');//扩展行数已经到最大
define('NO_EXTEND_LINE_ID','0x1000098');//没有扩展行id
define('NO_THIS_LINE_INFO','0x1000099');//此扩展行不存在
define('UNIQUEID_WORNG','0x1000100');//标识错误
define('EXTEND_FIELD_POSTTION_WRONG','0x1000101');//扩展单元位置错误
define('MAX_FIELD_NUM', '0x1000102');//扩展单元数目已到上限
define('AREA_POSITION_WRONG', '0x1000103');//错误的扩展区域属性
define('MUCH_LINE_LEFT_MAX_NUM','0x1000104');//多行扩展行左边只能放置1个扩展单元
define('MODULE_LISTUI_WORING','0x1000105');//此listui不可以设置固定搞定
define('CREATE_LEANCLOUD_USER_FAIL','0x1000106');//此listui不可以设置固定搞定
define('PACKAGE_NAME_EXIST','0x1000107');//包名已存在