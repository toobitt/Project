...
class contribute_contribute_content_materials extends adminBase
{
	public $field = 'id,expand_id,content_fromid, title,brief,content_id,mtype,original_id,host,dir,material_path,vodid,pic_name,pic,video';

	public $tablename = 'contribute_contribute_content_materials';
	
	public $child_tablename = '';
	
	public $child_table = '';
	
	public $array_field = 'pic,video';
...
$out = new contribute_contribute_content_materials();
$action = $_INPUT['a'];
