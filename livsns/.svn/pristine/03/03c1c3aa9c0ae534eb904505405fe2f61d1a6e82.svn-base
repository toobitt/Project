      	...
      	<tr height="40">	
      		<td id="liveheretd"> 
      			<div id="livehere_gid_div">
      				我当前位置<input name="livehere_gid_n" type="text" class="text" readonly=true value="<?php echo $default_gname?>" id="livehere_gid_n"/>
      			 	<input type="hidden" name="livehere_gid" id="livehere_gid" value="<?php echo $default_gid;?>" />
      				<input type="hidden" name="livehere_gid_lat" id="livehere_gid_lat" value="<?php echo $default_lat;?>" />
      				<input type="hidden" name="livehere_gid_lng" id="livehere_gid_lng" value="<?php echo $default_lng;?>" /> 
      			</div>	
      		</td> 
