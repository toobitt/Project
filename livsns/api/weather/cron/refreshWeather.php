<?php
define('MOD_UNIQUEID','refreshWeather');
define('ROOT_PATH', '../../../');
...
class refreshWeather extends cronBase
{
	...
	{
		//单队列
		$sql = 'SELECT locked FROM '.DB_PREFIX.'weather_refresh_queue';
	...
	{
		//锁定队列准备开始执行
		$this->db->query('REPLACE INTO '.DB_PREFIX.'weather_refresh_queue  value(0,1)');
	}
}
