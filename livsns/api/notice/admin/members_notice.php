<?php
define('MOD_UNIQUEID', 'members_notice'); //模块标识
require ('global.php');
class members_noticeApi extends adminReadBase 
{
    private $auth=null;
    ...
    {
        //is_deleted=2表示为删除
        $condition = " WHERE 1 AND a.`user_type`='members' and a.`is_deleted`=2 ";
         //查询发布的时间
