...
//哪里使用角标
define('MODULE_USE_SUPERSCRIPT',1);//模块 
define('COMPONENTS_USE_SUPERSCRIPT',2);//组件
$gGlobalConfig['app_store_status'] = array(
    0 => '待审核',
    1 => '已审核',
    2 => '被打回',
    3 => '已上架',
);
$gGlobalConfig['app_store_status_colors'] = array(
    0 => "#8ea8c8",
	1 => "#17b202",
	2 => "#f8a6a6",
    3 => "#17b202"
...
/**********************新扩展字段配置******************************************/
$gGlobalConfig['new_extend'] = array(
	'new_extend_list_ui' 				=> 'ExtendLayout',
	'need_set_list_ui_uniqueid' 		=> 'ListUI1',
	'new_extend_line_group_uniqueid'  	=> 'extend_line_group',
	'new_extent_field_group_uniqueid' 	=> 'extend_field_group',
	'extend_line_max_num'				=> 4,
	'special'							=> array(
												0 => array('field_type' => 2 , 'uniqueid' => 'price1'),
											),
	'extend_field_max_num'				=> 5,
	'set_line_position_ui_attr_name'	=> '扩展区域属性',
	'line_position'						=> array(
												'up'	=> 1,
												'down'	=> 2,
											),
	...
	'attribute_group_line_name'			=> 'extendLine',
	'attribute_group_field_name'		=> 'extendField',
	'price_style'						=> 2,
	'field_text_color'					=> array('alpha'=>1,'aColor'=>'#ff888888'),
	'line_type'							=> array('one'=>1,'much'=>'2'),
	'much_lines_left_field_num'			=> 1,
	'icons'								=> array(
												'author' 		=> 'dd_extend_author',
												'clickNum' 		=> 'dd_extend_click',
												'commentNum' 	=> 'dd_extend_comment',
												'keywords' 		=> 'dd_extend_keywords',
												'source' 		=> 'dd_extend_source',
												'create_time' 	=> 'dd_extend_time',
										),
	'extend_area_position'				=> array('fixed' => 1 , 'adaptive' => 2),
);
...
/**************************举报处理方式**************************/
//开发者申请技术要求
$gGlobalConfig['report_center_status'] = array(
    0 => '待处理',
    1 => '不处理',
    2 => '加入黑名单',
    3 => '已删除',
...
/**************************运营统计用***********************************/
$gGlobalConfig['statistics'] = array(
		'max_num' => 30,
