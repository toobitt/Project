...
require_once(CUR_CONF_PATH . 'lib/attribute_mode.php');
...
class attribute_update extends adminUpdateBase
{
	private $mode;
	private $attribute_type_mode;
	private $_upYunOp;
	private $app_material;
    public function __construct()
	{
		parent::__construct();
		$this->mode = new attribute_mode();
		$this->attribute_type_mode = new attribute_type_mode();
	...
	public function create()
	{
	    ...
	    else
	    {
	        ...
	        {
	            $this->errorOutput(THIS_UI_UNIQUEID_HAS_EXISTS);
	        }
	    }
