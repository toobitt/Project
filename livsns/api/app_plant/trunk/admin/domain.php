...
class domain extends adminReadBase
{
	private $mode;
	...
	public function get_condition()
	{
		...
		{
			$condition .= ' AND  (name  LIKE "%'.trim(($this->input['k'])).'%" or domain  LIKE "%'.trim(($this->input['k'])).'%")';
		}
		...
		if($this->input['is_display'])
		{
			$is_display = intval($this->input['is_display']);
			$condition .= " AND is_display='".$is_display."'";
		}
