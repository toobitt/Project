<?php
/***************************************************************************
* $Id: appAttrGroup.class.php 17481 2013-04-19 09:36:46Z yaojian $
***************************************************************************/
class appAttrGroup extends InitFrm
{
	...
	public function show($data)
	{
		...
		$sql = 'SELECT ' . $fields . ' FROM ' . DB_PREFIX . 'attr_group WHERE 1';
		//获取查询条件
	...
	public function count($data)
	{
		...
		$sql = 'SELECT COUNT(id) AS total FROM ' . DB_PREFIX . 'attr_group WHERE 1';
