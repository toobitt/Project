...
class domain_audit extends adminReadBase
{
	private $mode;
	...
	public function get_condition()
	{
		...
		{
			$condition .= ' AND  (web_url  LIKE "%'.trim(($this->input['k'])).'%" or i.name  LIKE "%'.trim(($this->input['k'])).'%")';
		}
		
		if($this->input['status'] || intval(($this->input['status'])))
		{
