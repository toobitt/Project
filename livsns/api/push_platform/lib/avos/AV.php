...
class AVRestClient
{
	 ...
	 *
	 */
	public function request($args,$appinfo)
	{
		$this->_appid 		= $appinfo['access_id'];
		$this->_appkey 		= $appinfo['access_key'];
		$this->_masterkey 	= $appinfo['secret_key'];
		$this->_AVurl		= $appinfo['avos_url'];
