...
class liv_magazine_magazine_magazine extends adminBase
{
	public $field = 'id,title,issue_id,sort_id,brief,state,user_name,create_time,update_time,contract_way,release_cycle,volume,current_nper,mana_nper,
	...
	public $tablename = 'liv_magazine_magazine_magazine';
	
	public $child_tablename = 'liv_magazine_magazine_magazine_issue';
	
	public $child_table = 'issue';
...
$out = new liv_magazine_magazine_magazine();
$action = $_INPUT['a'];
