...
class tuji_tuji_m_tujiApi extends BaseFrm
{
	public $field = 'id,expand_id,content_fromid,title,brief,tuji_sort_id,default_comment,user_name,create_time,ip,update_time,status,total_pic,keywords,total_visit,total_comment,cover_url,path,order_id,auto_cover,is_namecomment,is_orderby_name,is_add_water,water_id,tuji_source';

	public $tablename = 'liv_tuji_tuji_m_tuji';
	
	public $child_tablename = 'liv_tuji_tuji_m_tuji_tuji_pics';
