...
class media_channel_vod_vod extends adminBase
{
	public $field = 'id,expand_id,content_fromid,title,brief,video_order_id,channel_id,img,bitrate,vod_sort_id,status,author,user_id,addperson,source,starttime,delay_time,height,start,duration,width,vodid,keywords,type,transize,totalsize,audit,create_time,update_time,ip,vod_leixing,aspect,vtype,from_appid,from_appname,server,hostwork,video_path,video_filename,weight,outlink';

	public $tablename = 'media_channel_vod_vod';
