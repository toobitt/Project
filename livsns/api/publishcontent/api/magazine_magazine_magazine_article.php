...
class liv_magazine_magazine_magazine_article extends adminBase
{
	public $field = 'id,title,subhead,brief,tcolor,isbold,isitalic,article_author,redactor,issue_id,group_id,
	...
	public $tablename = 'liv_magazine_magazine_magazine_article';
	
	public $child_tablename = 'liv_magazine_magazine_magazine_article_material';
...
$out = new liv_magazine_magazine_magazine_article();
$action = $_INPUT['a'];
