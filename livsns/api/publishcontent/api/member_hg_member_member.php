...
class liv_member_hg_member_member extends BaseFrm
{
	public $field = 'id,expand_id,content_fromid,title,brief,outlink';

	public $tablename = 'liv_member_hg_member_member';
...
$out = new liv_member_hg_member_member();
$action = $_INPUT['a'];
