...
class liv_community_thread_thread extends BaseFrm
{
	public $field = 'id,cuser_id,cuser_name,content_fromid,title,brief,outlink';

	public $tablename = 'liv_community_thread_thread';
...
$out = new liv_community_thread_thread();
$action = $_INPUT['a'];
