...
class special_special_special extends adminBase
{
	public $field = 'id,content_fromid,name,tcolor,sort_id,isbold,isbold,link,order_id,keywords,pic,brief,weight,status,other_settings,use_id,user_name,create_time,update_time,ip,pub_time,expand_id,column_id,colunmn_url';

	public $tablename = 'special_special_special';
...
$out = new special_special_special();
$action = $_INPUT['a'];
