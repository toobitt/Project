...
class tuji_tuji_tuji_tuji_pics extends adminBase
{
	public $field = 'id,expand_id,content_fromid,title,brief,tuji_id,material_id,old_name,new_name,thumb_name,path,total_visit,status,is_cover,create_time,update_time,ip,order_id,pic';

	public $tablename = 'tuji_tuji_tuji_tuji_pics';
	
	public $child_tablename = '';
	
	public $child_table = '';
	
	public $array_field = 'pic,img_info';
...
$out = new tuji_tuji_tuji_tuji_pics();
$action = $_INPUT['a'];
