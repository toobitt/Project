...
class webvod_webvod_webvod extends adminBase
{
	public $field = 'id,expand_id,content_fromid,array_child_field,keywords,indexpic,title,brief,category_id,cpid,cpname,maid,video_source,video_id,program_form,media_type,program_type,duration,status,bitrate,create_date,create_time,ip';

	public $tablename = 'webvod_webvod_webvod';
