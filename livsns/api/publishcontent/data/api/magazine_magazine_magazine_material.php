...
class liv_magazine_magazine_magazine_material extends adminBase
{
	public $field = 'id,cid,expand_id,content_fromid,material_id,name,pic_host,pic_dir,pic_filepath,pic_filename,type,imgwidth,imgheight,filesize,isdel,create_time,ip,remote_url,title,brief,pic';

	public $tablename = 'liv_magazine_magazine_magazine_material';
	
	public $child_tablename = '';
	
	public $child_table = '';
	
	public $array_field = 'pic';
...
$out = new liv_magazine_magazine_magazine_material();
$action = $_INPUT['a'];
