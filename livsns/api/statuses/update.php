...
*
* $Id: update.php 17941 2013-02-26 02:20:49Z repheal $
***************************************************************************/
define('ROOT_DIR', '../../');
require(ROOT_DIR . 'global.php');
class updateApi extends appCommonFrm
{
	private $member;
	...
	*/
	private function insert($info , $type=0)
	{
		...
		$location = $this->member->get_location();
		if($location)
		{
			$lat = $location['lat'];
			$lng = $location['lng'];
		 ...
		 * 添加发送微博积分
		 */
		$this->member->add_credit_log(SENT_STATUS);
