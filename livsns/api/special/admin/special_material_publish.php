...
class MaterialPublish extends adminUpdateBase implements publish
{
	...
	public function get_content()
	{
		...
		$sql = "SELECT * FROM " . DB_PREFIX ."special_material where 1 and special_id=" . $id ." and expand_id = '' and del = 0 ". $data_limit;
		...
		while($row = $this->db->fetch_array($info)) 
		{
			...
			$row['struct_ast_id'] = 'special_material';
 	...
 	function update_content()
 	{
		...
		$sql = "UPDATE " . DB_PREFIX. "special_material 
