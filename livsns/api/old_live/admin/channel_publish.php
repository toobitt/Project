...
*
* $Id: channel_publish.php 17966 2013-02-26 06:11:46Z repheal $
***************************************************************************/
...
class  channel_publish  extends adminBase implements publish
{
	...
	public function get_content()
	{
		...
		if ($channel_info['logo_info'])
		{
			...
			$info['indexpic']['host'] 	  = $channel_info['logo_info']['host'];
			$info['indexpic']['dir'] 	  = $channel_info['logo_info']['dir'];
			$info['indexpic']['filepath'] = $channel_info['logo_info']['filepath'];
			$info['indexpic']['filename'] = $channel_info['logo_info']['filename'];
		}
		else 
		{
			$info['indexpic'] = '';
		...
		$info['open_ts'] = $channel_info['open_ts'];
		$info['audio_only'] = $channel_info['audio_only'];
		$info['stream_name'] = $channel_info['stream_info_all'];
	...
	public function create_table()
	{
		...
		$data = array(
			...
			'struct_id'     => "channel",
			'struct_ast_id' => "",
			'field'         => "id,expand_id,content_fromid,title,brief,outlink,code,logo_info,open_ts,audio_only,stream_name",
			'array_field'   => "",
			'array_child_field'   => "",
			'table_title'   => "直播频道",
			'field_sql'   	=> "  `id` int(10) NOT NULL AUTO_INCREMENT,
								  ...
								  `logo_info` varchar(512) NOT NULL,
								  `open_ts` tinyint(1) NOT NULL,
								  `audio_only` tinyint(1) NOT NULL,
