...
***************************************************************************/
class programScreen extends InitFrm
{
	...
	{	
		...
		$sql_ =  "SELECT * FROM " . DB_PREFIX . "program_screen WHERE id = " . trim($this->input['id']);
	...
	public function delete()
	{
		...
		if($id)
		{
			...
			$sql_ =  "SELECT * FROM " . DB_PREFIX . "program_screen WHERE id IN (" . $id . ")";
