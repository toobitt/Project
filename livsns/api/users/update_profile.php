...
*
* $Id: update_profile.php 17947 2013-02-26 02:57:46Z repheal $
***************************************************************************/
define('ROOT_DIR', '../../');
require(ROOT_DIR . 'global.php');
require('../lib/user.class.php');
class updateProfileApi extends appCommonFrm
{
	...
	*/
	...
	public function updateProfile()
	{
		...
		else 
		{
			...
			{
				$result = $this->mUser->checkUsername($userinfo['username']);
				if($result)
				{
			...
			{
				$result = $this->mUser->checkEmail($userinfo['email']);
				if($result)
				{
