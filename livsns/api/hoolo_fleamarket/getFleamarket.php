...
require ('./global.php');
require_once CUR_CONF_PATH.'lib/fleamarket.class.php';
class getRoad extends outerReadBase
{
	...
	public function get_condition()
	{
		...
		if($this->input['is_sale']!="")
		{
			$condition .=" AND r.is_sale =" . intval($this->input['is_sale']);
		}

		if($this->input['state'])
		{
			$condition .=" AND r.state =" . intval($this->input['state']);
		}
		if($this->input['user_id'])
		{
			$condition .=" AND r.user_id =" . intval($this->input['user_id']);
		}		

		if($areas = $this->input['areas'])
		{
			$condition .=" AND r.areas ='" . $areas . "'";
		}
