<?php 
/* $Id: upload.tpl.php 3643 2011-04-15 09:37:14Z chengqing $ */
?>
		...
		<div class="show_info">
			...
			<ul>
				...
				<li>
					...
					<?php
					foreach($this->settings['album'] as $k => $v)
					{
						if($k % 10 == 0)
						{
							?> 
					...
					?> 
						<input id="video_sort_<?php echo $k; ?>" type="radio"  name="video_sort" value="<?php echo $v['id'] ?>" checked="<?php echo $v['checked']; ?>" /><label for="video_sort_<?php echo $k; ?>"><?php echo $v['name'];?></label>
					<?php 		
					}					
					?>
					</div>
