<?php 
/* $Id: add_program.tpl.php 1887 2011-01-26 10:42:42Z repheal $ */
?>
<style type="text/css">
...
<div id="idVideo" class="lightbox" style="top:10%;left:5%;">
	...
	<h3><span id="idVideoClose">X</span><?php echo $this->lang['edit']?></h3>
	<div class="text">
	<ul>
		...
		<li>
			...
			{
			?> 
				<input id="edit_sort_<?php echo $k; ?>" type="radio"  name="edit_sort" value="<?php echo $v['id'] ?>" checked="<?php echo $v['checked']; ?>" />
				<label for="edit_sort_<?php echo $k; ?>"><?php echo $v['name'];?></label>
			<?php 		
			}					
			?>
			</div>
