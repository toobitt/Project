<?php 
/* $Id: add_program.tpl.php 3386 2011-04-07 01:54:52Z repheal $ */
?>
<style type="text/css">
...
<div id="idBox" class="lightbox" style="top:10%;left:5%;">
	...
	<div class="lightbox_middle">
		<h3><span id="idBoxClose">X</span><?php echo $this->lang['add_program']?></h3>
		<div class="text">
		<ul>
			<li style="float:left;"><?php echo $this->lang['video_name']?><input id="v_name" style="width:257px;" disabled type="text"/></li>
			<li style="float:left;padding-left: 36px;"><?php echo $this->lang['program_name']?><input id="p_name" style="width:165px;" type="text"/><span id="p_name_tip" style="font-size:12px;color:red;padding-left:5px;display:none;">*</span></li>
			<li class="clear1"></li>
			<li><?php echo $this->lang['program_brief']?><textarea id="p_brief" rows="3" cols="62"></textarea></li>
			...
			<input type="hidden" id="end_time" value="0"/>
				<div id="video_list" class="video_list">
					...
					else
					{
						...
						{
						?>
						<li><span>·</span><a href="javascript:void(0);" onclick="add_program(<?php echo $value['id'];?>,<?php echo $sta_id;?>,<?php echo $value['toff'];?>)"><?php echo hg_cutchars($value['title'],10,"..");?></a><span id="v_<?php echo $value['id'];?>" style="display:none;"><?php echo $value['title'];?></span><img src="<?php echo RESOURCE_DIR;?>img/play_bt.jpg"/></li>
						<?php 
						}
					}
					?>
