		        	...
		        	else
		        	{
		        		...
		        		if(reply_id==0)
	        			{
		        			$.each(obj,function(k,v){
								...
								if(REWRITE)
								{
									var link = SNS_UCENTER+'user-' + v.user.id + '.html';
								}
								else
								{
									var link = SNS_UCENTER+'user.php?user_id='+v.user.id;
								}
			        			...
			        			'<div class="comment-img"><a target="_blank" href="'+ link +'"><img src="'+v.user.middle_avatar+'"/></a></div>'+
			        			'<div class="comment-bar">'+
			        			'<a target="_blank" class="bar-left" href="'+ link +'">'+v.user.username+'</a>'+
			        			...
			        			'<a id="re_'+v.id+'_'+v.user.id+'" onclick="report_play('+v.id+','+v.user.id+');" href="javascript:void(0);" style="display:none;">举报</a> '+
