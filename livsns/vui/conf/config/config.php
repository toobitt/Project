...
define('TEMPLATES_DIR', ROOT_PATH . 'vui/tpl/'); //模板路径
define('RESOURCE_DIR', ROOT_DIR . 'vui/res/');   //资源路径
...
define('ALLOW_PROGRAME',true);
if(!ALLOW_PROGRAME && defined(ALLOW_PROGRAME))
{
