<?php include hg_load_template('head_register_login');?>
 ...
 <table width="695" border="0" align="center" cellpadding="0" cellspacing="0" height="420" class="content_user_info">
  <tr>
    <td width="113" align="right" valign="middle"><span class="red">*</span><?php echo $this->lang['username'];?>：</td>
  ...
  <tr>
    ...
    <td width="320" height="40" align="left" valign="middle"  class="color"><input type="radio" name="sex" value="1" <?php if($this->userinfo['sex']==1) echo "checked";?> ><?php echo $this->lang['male'];?>&nbsp;&nbsp;
		<input type="radio" name="sex" value="2" <?php if($this->userinfo['sex']==2) echo "checked";?>><?php echo $this->lang['female'];?></td>
