...
/*
	...
	$Id: admin.php 3108 2011-03-28 08:25:57Z chengqing $
*/
...
require UC_DATADIR.'global.conf.php';
...
if(in_array($m, array('ugroup','admin', 'app', 'badword', 'pm', 'cache', 'db', 'domain', 'frame', 'log', 'note', 'feed', 'mail', 'setting', 'user', 'uset','credit', 'seccode', 'tool', 'plugin','invitecode'))) {
