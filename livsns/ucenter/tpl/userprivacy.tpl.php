...
<div class="registering">
	...
	<div class="content_top"></div>	
		...
		?>
		<p>
			<label><input type="radio" name="visit_user_info" checked="checked" value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>
		<?php 
			}
		...
		?>
		<p>
			<label><input type="radio" name="visit_user_info"  value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>		
		<?php
			}
		...
		?>
		<p>
			<label><input type="radio" name="follow" checked="checked" value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>
		<?php 
			}
		...
		?>
		<p>
			<label><input type="radio" name="follow"  value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>		
		<?php
			}
		...
		?>
		<p>
			<label><input type="radio" name="comment" checked="checked" value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>
		<?php 
			}
		...
		?>
		<p>
			<label><input type="radio" name="comment"  value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>		
		<?php
			}
		...
		?>
		<p>
			<label><input type="radio" name="search_true_name" checked="checked" value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>
		<?php 
			}
		...
		?>
		<p>
			<label><input type="radio" name="search_true_name"  value="<?php echo $k; ?>"/>			
			<?php echo $v; ?></label>
		</p>		
		<?php
			}
