...
/*
	...
	$Id: client.php 776 2010-12-17 05:47:15Z yuna $
*/
...
function uc_fopen($url, $limit = 0, $post = '', $cookie = '', $bysocket = FALSE, $ip = '', $timeout = 15, $block = TRUE) {
	...
	//return ($ip ? $ip : $host).$port.$errno. $errstr. $timeout;
...
function uc_user_synupdatepw($username,$password,$salt) {
	$return = uc_api_post('user', 'edit', array('username'=>$username,'newpw'=>$password,'salt'=>$salt));
	return $return;
}
