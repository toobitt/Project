...
* 
* $Id: 5gpicture.php 4294 2011-07-31 08:28:38Z repheal $
***************************************************************************/
define('ROOT_DIR', '../../');
...
class gguandian extends LivcmsFrm
{
	...
	public function show()
	{
		...
		$sql = "SELECT g.*,ma.* FROM ".DB_PREFIX."5gpicture g
		...
		$this->setXmlNode('gpictures' , 'gpicture');
	...
	{	
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "5gpicture WHERE 1 ";
		//获取查询条件
