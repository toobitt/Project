...
<div style="display:none">
	...
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<span class="add-font-pack button_6">添加背景图</span>
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="背景图片/名称">背景图片/名称</div>
            <div class="m2o-item m2o-state" title="类型">类别</div>
        ...
        <div class="m2o-each-list">
        	{if is_array($list) && count($list)>0}
				{foreach $list as $k => $v}	
		            {template:unit/verify_bgpicture_list_list}
		        {/foreach}
			{else}
...
<div class="m2o-item m2o-audit" _status="0" style="color:#8ea8c8;" >待审核</div>
