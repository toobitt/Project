<div style="position: absolute; z-index: 99; left:30%;overflow:hidden;height:315px;" id="dialog_{$salt_str}">
<div class="MMaskBox">
					...
					<div class="MBottom">
						<div class="MBTop">
							<div id="contentTop_{$salt_str}" class="MBTBox"> 
								...
								{foreach $messages as $pid => $p_info}
								...
								<li id="pm_{$p_info['pid']}" class="{$class}"><div class="eachMessage clearfix"><div class="left"><span  class="user_name">{$p_info['fromwho']}</span></div><div class="right"><?php echo hg_get_date($p_info['stime'])?></div><div style="color: rgb(125, 125, 125);" class="eachMessageCon">{$p_info['content']}</div></div></li>
								{/foreach}
								</ul> 
							</div>
						</div>
									...
									<div>
										...
										<div class="messageCon">
											...
											<div class="clear">
												...
												<a onclick="return sendMessage('{$salt_str}');" href="javascript:void(0);" class="sumbit" id="s{$salt_str}"></a>
												<a onclick="return false;" href="javascript:void(0);" class="disabled" id="dis_submit{$salt_str}" style="display:none;"></a>
											</div>
										</div>
