<?php
/* $Id: avatar.php 543 2011-08-29 01:17:33Z repheal $ */
?>
{template:head}
<script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#avatat_upload').ajaxForm(function(data) {
	            ...
	            if(data == 1)
	            {
	             	alert('上传的图片应小于1000*1000像素,大于50*50像素!');   
	            }
	            else if(data == 2)
	            {
		...
		<div class="con-avatar" id = "avatar" style="padding:20px 0 20px 143px;">
			<form id="avatat_upload" action='avatar.php' method='post' enctype='multipart/form-data'>
				<div style="float:left;">
					<img id="avatar_img" style="border: 2px solid #DDDDDD;padding:8px;" src="{$user_info[0]['larger_avatar']}?<?php echo TIMENOW;?>" />							
				</div>
