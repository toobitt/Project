	            ...
	            <form method="post" action="" name="pos_listform">
	               <!-- 标题 -->
                    <ul class="common-list public-list-head">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                                ...
                                <div class="archive-gdr common-list-item open-close wd100">添加人</div>
                                <div class="archive-gdip common-list-item open-close wd100">ip</div>
                           		<div class="archive-gdsj common-list-item open-close wd150">时间</div>
                            </div>
		        	...
		        	<ul class="common-list public-list hg_sortable_list" data-order_name="order_id" id="archive_list">
						{if $archive_content_list}
			       			{foreach $archive_content_list as $k => $v} 
			                	{template:unit/archive_content_list}
			                {/foreach}
			  			{/if}
		            </ul>
			        <ul class="common-list">
				      <li class="common-list-bottom clear">
					   <div class="common-list-left">
						    ...
						    <a name="bataudit"  onclick="return hg_ajax_batchpost(this, 'recover', '还原', 1, 'id', '&archive_id={$archive_content_list[0][archive_id]}', 'ajax');" style="cursor:pointer;">还原</a>
						    <a name="batdelete"  onclick="return hg_ajax_batchpost(this, 'delete', '删除', 1, 'id', '&archive_id={$archive_content_list[0][archive_id]}', 'ajax');" style="cursor:pointer;">删除</a>
						</div>
			              {$pagelink}
			          </li>
			       </ul>
