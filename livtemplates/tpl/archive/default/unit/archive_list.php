<li class="common-list-data clear"  id="r_{$v['id']}" _id="{$v['id']}"  name="{$v['id']}"   order_id="{$v['order_id']}">
    ...
    <div class="common-list-right">
       ...
       <div class="common-list-item archive-hy wd60">
            <div class="common-list-cell">
                <a class="btn-box" onclick="return hg_ajax_post(this, '还原', 1);" href="./run.php?mid={$_INPUT['mid']}&a=recover_archive&id={$v['id']}&infrm=1">还原</a>
            </div>
       </div>
   ...
   <div class="common-list-biaoti ">
	    <div class="common-list-item archive-biaoti biaoti-transition">
		   <div class="common-list-cell">
			   <span class="archive-biaoti-overflow"><a href="./run.php?a=relate_module_show&app_uniq=archive&mod_uniq=archive_content&archive_id={$v['id']}&infrm=1">
