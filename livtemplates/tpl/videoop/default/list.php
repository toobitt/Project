...
<div {if $_INPUT['infrm']}style="display:none"{/if}>
    <div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
        <a class="add-button news mr10" href="run.php?mid={$_INPUT['mid']}&a=form&infrm=1" target="nodeFrame">添加百度收录配置</a>
    </div>
</div>
        ...
        <ul class="common-list news-list">
            <li class="common-list-head public-list-head clear">
                ...
                <div class="common-list-right">
                    <div class="common-list-item open-close" style="width:480px;">XML文件地址</div>
