		...
		<form method="post" action="" name="listform" class="common-list-form">
			<ul class="common-list">
				<li class="common-list-head public-list-head clear">
					...
					<div class="common-list-biaoti">
						<div class="common-list-item wd120">标识</div>
						<div class="common-list-item wd150">名称</div>
						<div class="common-list-item laiyuan wd120">添加时间</div>
				    </div>
				</li>
			</ul>
			...
			<ul class="common-list site-list public-list" id="sitelist">
				...
				<li class="common-list-data clear" id="r_{$v['id']}">
					...
					<div class="common-list-biaoti">
					   <div class="common-list-item biaoti-content biaoti-transition wd120">
						    <span class="common-list-overflow wd150" style="height: 50px;margin: 5px 0px;"><img style="width:40px;height:40px;" src="{$v['logo_url']}" /></span>
					   </div>
					   <div class="common-list-item biaoti-content biaoti-transition wd120">
