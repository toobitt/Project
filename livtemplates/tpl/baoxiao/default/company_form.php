...
<li class="i">
    <div class="form_ul_div clear">
        <span class="title">法人：</span><input type="text" value='{$legal}' name='legal' class="site_title">
    </div>
</li>
<li class="i">
    <div class="form_ul_div clear">
        <span class="title">联系方式：</span><input type="text" value='{$tel}' name='tel' class="site_title">
    </div>
</li>
<li class="i">
    <div class="form_ul_div clear">
        <span class="title">地址：</span><input type="text" value='{$address}' name='address' class="site_title">
    </div>
</li>
</ul>
