...
function hg_call_project_del(data)
{
	data = data.replace(/'/g, "");
	var ids = data.split(",");
...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10"  href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增项目</em></span>
		...
		<form method="post" action="" name="listform" class="common-list-form">
			<ul class="common-list">
				<li class="common-list-head public-list-head clear">
					...
					<div class="common-list-biaoti">
						<div class="common-list-item wd150">项目名称</div>
						<div class="common-list-item address wd100">报销单总数</div>
				    </div>
				</li>
			</ul>
			...
			<ul class="common-list site-list public-list" id="sitelist">
				...
				<li class="common-list-data clear" id="r_{$v['id']}">
					...
					<div class="common-list-biaoti">
					   <div class="common-list-item biaoti-content biaoti-transition wd150">
								<span class="common-list-overflow wd150">{$v['name']}</span>
					  </div>
					  <div class="common-list-item jm-name wd100">
								<span class="common-list-overflow  max-wd100 m2o-common-title" title="{$v['title']}">
								{code} echo hg_cutchars($v['business_count'],12,'');{/code}
								</span>
						</div>	
					</div>
...
<div id="record-edit">
	<div class="record-edit">
		<div class="record-edit-btn-area clear">
			...
			<a href="javascript:void(0);" onclick="hg_project_del(${id});">删除</a>
		</div>
