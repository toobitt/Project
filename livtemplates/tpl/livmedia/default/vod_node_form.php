...
<li class="i">
	...
	<input  type="text" name="sort_name" id="sort_name" style="width:420px;height:26px;{if $formdata['color']}color:{$formdata['color']};{/if}"  class="info-title info-input-left t_c_b iColorPicker" value="{if $formdata['name']}{$formdata['name']}{else}在这里添加标题{/if}" onfocus="text_value_onfocus(this,'在这里添加标题');" onblur="text_value_onblur(this,'在这里添加标题');" ishidden="true" />
...
<br />
<input type="submit" name="sub" value="{$optext}" class="button_6_14"  style="float: left;" />
</form>