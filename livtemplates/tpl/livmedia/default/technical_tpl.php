	...
	<div style='height:300px;margin-top:30px;overflow:auto;'>
		...
		{foreach $vinfo['VideoResult'] AS $kk => $vv}
			<div style='width:100%;height:20px;'>
				  ...
				  <div style='width:100px;float:left;height:20px;margin-left:20px;'>{$vv['Length']}帧</div>
				  <div style='width:100px;float:left;height:20px;margin-left:20px;'>{$_configs['ReviewResultType'][$vv['Type']]}</div>
			</div>
		{/foreach}
	</div>
	<div style='height:300px;margin-top:30px;overflow:auto;'>
		...
		{foreach $vinfo['AudioResult'] AS $kkk => $vvv}
			<div style='width:100%;height:20px;'>
				  ...
				  <div style='width:100px;float:left;height:20px;margin-left:20px;'>{$vvv['Length']}帧</div>
