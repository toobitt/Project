<div class="info clear">
	<input  type="text" name="title" id="title{$hg_name}"   class="info-title info-input-left t_c_b" placeholder="在这里添加标题" />
	<textarea rows="2" class="info-description info-input-left t_c_b" name="comment"  id="comment{$hg_name}"  placeholder="这里输入描述"></textarea>
</div>
...
{code}
  ...
  $options = array('maxShow' => 2);
{/code}

<div style="background:#F9F9F9;margin:10px 0;">
{template:unit/publish, 2, $formdata['column_id']}
</div>