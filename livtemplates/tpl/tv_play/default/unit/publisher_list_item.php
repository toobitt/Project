<li class="common-list-data clear" _id="{$v['id']}" id="r_{$v['id']}" name="{$v['id']}" >
    ...
    <div class="common-list-right">
        ...
        <div class="common-list-item wd60" style="cursor:pointer;"  onclick="hg_audit_publisher({$v['id']});">
                <span id="status_{$v['id']}">{$v['status_format']}</span>
        </div>
    ...
    <div class="common-list-biaoti" href="run.php?mid={$_INPUT['mid']}&a=form&id={$v['id']}&infrm=1">
        <div class="common-list-item biaoti-transition">
                <a>
	                <span class="common-list-overflow max-wd fz14" style="display:inline-block;">{$v['name']}</span>
                </a>
        </div>
    </div>
</li>