...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}&session_id={$_INPUT[id]}" target="nodeFrame">
                ...
                <form method="post" action="" name="listform">
                    <ul class="common-list">
                        <li class="common-list-head clear">
                            <div class="common-list">
                            	...
                            	<div class="common-list-item"  style="width:800px;">内容</div>
	                ...
	                <ul class="common-list" id="contri_sortlist">
		       			{if !empty($formdata)}
		       			    ...
		       			    {template:unit/detail_message_row}
						{else}
