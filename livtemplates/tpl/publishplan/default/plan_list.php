                   ...
                   <ul class="common-list" id="list_head">
                        <li class="common-list-head clear public-list-head">
                            ...
                            <div class="common-list-right">
                                <div class="common-list-item wd80">操作类型</div>
                                <div class="common-list-item wd60">状态</div>
                                <div class="common-list-item wd150">发布人/时间</div>
                            </div>
	                ...
	                <ul class="common-list public-list" id="tujilist">
					    {if $plan_list[0]}
		       			    {foreach $plan_list[0] as $k => $v} 
		                      {template:unit/planlist}
		                    {/foreach}
						{else}
