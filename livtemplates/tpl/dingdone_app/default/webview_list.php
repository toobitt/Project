...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增模块</em></span>
                    ...
                    <ul class="common-list">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                            	<div class="group-cz common-list-item open-close">模块描述</div>
                            	<div class="group-cz common-list-item open-close" style="width:300px;">请求地址</div>
                            	<div class="group-cz2 common-list-item open-close" style="padding-right:5px;">操作</div>
                            </div>
                            <div class="common-list-biaoti">
						        <div class="common-list-item open-close group-title">模块名称</div>
					        </div>
                        </li>
                    </ul>
