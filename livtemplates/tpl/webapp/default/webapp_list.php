<?php 
/* 
$Id:webapp_list.php 17960 2013-03-21 14:28:00 jeffrey $ 
*/
?>
{template:head}
{code}
	...
	<div class="f">
          <div class="right v_list_show">
			...
			<div class="list_first clear" id="list_head">
                   ...
                   <a style="width:100px;margin-top:8px;float:left;">内容标题</a>
				   <a style="width:100px;margin-top:8px;float:left;">顶</a>
				   <a style="width:100px;margin-top:8px;float:left;">踩</a>
				   <a style="width:100px;margin-top:8px;float:left;">评分值</a>
				   <a style="width:150px;margin-top:8px;float:left;">纪录时间</a>
