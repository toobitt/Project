          ...
          <div class="right v_list_show">
                ...
                <form method="post" action="" name="vod_sort_listform">
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            <div class="common-list-left">
                                <div class="common-list-item paixu">
			 	                   <a title="排序模式切换/ALT+R" onclick="hg_switch_order('set_list');"  class="common-list-paixu"></a>
			                    </div>
                            </div>
                            <div class="common-list-right">
                                <div class="common-list-item wd60">编辑</div>
                                <div class="common-list-item wd60">删除</div>
                                 <div class="common-list-item wd100">绑定分类</div>
                                <div class="common-list-item wd100">直接转发</div>
                                <div class="common-list-item wd100">状态</div>
                                <div class="common-list-item open-close wd200">添加人/添加时间</div>
                            </div>
	                ...
	                <ul class="common-list hg_sortable_list public-list" id="set_list" data-order_name="order_id" data-table_name="gather_set">
					    {if $list}
		       			    {foreach  $list as $k => $v}
		                      {template:unit/gathersetlist}
		                    {/foreach}
		                {else}
