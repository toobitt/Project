...
{css:gather_list}
{code}
$content = htmlspecialchars_decode($formdata['content']);
{/code}
<div class="wrap common-list-content">
	...
	<div class="gather-box">
		...
		<ul class="info clear">
			...
			<li><label>分类：</label>{template:form/search_source,sort_id, $formdata['sort_id'], $name,$item_source}</li>
			...
			<input type="text" title="链接地址" name="source_url" value="{$formdata['source_url']}" />
		</ul>
