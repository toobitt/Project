...
<div style="display:none">
	{template:unit/configSet_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6">新增配置项</a>
	</div>
</div>
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action method="post" enctype='multipart/form-data'>
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="名称">设置名称</div>
            <div class="m2o-item m2o-mark" title="标识">设置标识</div>
            <div class="m2o-item m2o-brief" title="设置描述">设置描述</div>
            <div class="m2o-item m2o-type" title="标识">设置值</div>
            <div class="m2o-item m2o-sort" title="所属分类标识">所属分类标识</div>  
           <!--   <div class="m2o-item m2o-mark" title="配置类型">配置标识</div> -->
        ...
        <div class="m2o-bottom m2o-flex m2o-flex-center">
    		...
    		<div class="m2o-item m2o-flex-one list-config">
    		 <!-- <a class="batch-handle">删除</a> -->
    		   <input type="hidden" name="a" value="updatelistset" />
    		   <input type="submit" name="sub" value="保存设置" class="edit-button submit"/> 
    		</div>
...
<div class="m2o-option" data-id="{{= id}}">
    <div class="m2o-option-inner m2o-flex">
        <div class="m2o-btns m2o-flex">
			...
			{{if value!=defaultvalue}}<a href="./run.php?mid={$_INPUT['mid']}&a=restoreset&id={{= id}}&infrm=1">恢复默认</a>{{/if}}
				<a></a>
				<a></a>
			</div>
