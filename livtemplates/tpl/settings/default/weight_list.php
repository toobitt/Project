<?php 
/* 
$Id:weight_list.php 17960 2013-03-21 14:28:00 jeffrey $ 
*/
?>
{template:head}
{code}
...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
	...
	<a class="blue mr10"  href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增类别</em></span>
	...
	<div class="f">
          <div class="right v_list_show">
			...
			<div class="list_first clear" id="list_head">
				   <span class="left">
                    	<a style="margin-left:23px;margin-right:15px;margin-top:10px;" title="排序模式切换/ALT+R" onclick="hg_switch_order('newslist');" ></a>
                   </span>
                   <a style="width:150px;margin-top:8px;float:left;">标题</a>
				   <a style="width:150px;margin-top:8px;float:left;">初始值</a>
				   <a style="width:150px;margin-top:8px;float:left;">终点值</a>
