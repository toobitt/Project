...
<div style="display:none">
	{template:unit/copywriting_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6">新增文案</a>
	</div>
</div>
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="事件名称">名称</div>
             <div class="m2o-item m2o-mark" title="操作key">标识</div> 
             <div class="m2o-item m2o-sort" title="所属分类">所属分类</div>
