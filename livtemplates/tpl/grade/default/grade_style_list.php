                   ...
                   <ul class="common-list public-list-head" id="list_head">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                                <div class="common-list-item fbz overflow common-list-pub-overflow">名称</div>
<!--                                 <div class="common-list-item open-close wd60">操作</div> -->
                                
                                <div class="common-list-item open-close wd70">分制</div>
                                
                                 <div class="common-list-item open-close ">状态</div>
                                <div class="common-list-item open-close vote-tjr wd120">添加人/时间</div>
                            </div>
                            <div class="common-list-biaoti ">
						        <div class="common-list-item open-close vote-biaoti">缩略图</div>
					        </div>
                        </li>
                    </ul>
                <ul id="vodlist" class="common-list channel-list  public-list hg_sortable_list" data-table_name="channel" data-order_name="order_id">
				    ...
				    {if $list}
	       			    {foreach $list AS $k => $v}
	                  		{template:unit/grade_style_list_list} 
	                    {/foreach}
					{else}
