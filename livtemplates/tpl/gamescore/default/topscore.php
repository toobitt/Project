...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="nodeFrame"></a>
</div>
                ...
                <form method="post" action="" name="listform">
                        ...
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-left">
                             ...
                             <div class="common-list">
                            	...
                            	<div class="circle-tjr common-list-item open-close">游戏</div>
                            	<div class="circle-tjr common-list-item open-close">用户</div>
                                <div class="circle-tjr common-list-item open-close">得分</div>
                            </div>                       
                        </li>
                    </ul>
	                <ul class="common-list" id="contri_sortlist">
		       			{if $list && is_array($list)}
		       			    {foreach $list as $k => $v} 
		                      {template:unit/detail_common_topscore_row}
		                    {/foreach}
						{else}
