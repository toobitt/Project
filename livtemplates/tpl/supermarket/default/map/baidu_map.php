...
<div class="market-tude">
<span><label>经度：</label><input type="text" name="{$hg_name}" id="{$hg_name}" value="{$hg_data['longitude']}" size="35" /></span>
<span><label>纬度：</label><input type="text" name="$hg_value" id="$hg_value" value="{$hg_data['latitude']}" size="35" /></span>
</div>
