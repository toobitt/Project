...
var swfu;
//alert("./run.php?mid=" + gMid + "&a=upload&admin_id=" + gAdmin.admin_id + "&admin_pass=" + gAdmin.admin_pass);
	...
	<div class="form_ul_div clear">
		<span class="title">分类名称：</span>
			<div style="display:inline;float:left;margin-right:10px;">
				<input type="text" value='{$title}' name='name' class="title" style="width:200px;" id="vod-title">
			</div>
			<div class="form-title-option clearfix" style="display:inline;">
					<span class="form-title-color"></span>
			</div>
		<input name="color" type="hidden" value="{$color}" id="tcolor" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
