...
<div style="display:none">
	{template:unit/membermydata_search}
</div>
<!-- 记录列表 -->
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="图标/名称">数据名称</div>
            <div class="m2o-item m2o-mark" title="标识">数据标识</div>
            <div class="m2o-item m2o-mark" title="数据所属人">数据所属人</div>
            <div class="m2o-item m2o-time" title="创建时间">创建时间</div>
            <div class="m2o-item m2o-time" title="创建时间">更新时间</div>
           <!--  <div class="m2o-item m2o-time" title="添加人/时间">添加人/时间</div>-->
        </div>
        <div class="m2o-each-list">
        	{if $list}
	        {foreach $list as $k => $v}
	        	{template:unit/membermydatalist}
	        {/foreach}
	        {else}
    ...
    <div class="m2o-option-inner m2o-flex">
        <div class="m2o-btns m2o-flex">
			<div class="m2o-btn-area m2o-flex">
				<a href="./run.php?mid={$_INPUT['mid']}&a=form&id={{= id}}&infrm=1" target="nodeFrame">查看</a>
