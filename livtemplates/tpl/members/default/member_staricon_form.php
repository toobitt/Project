...
<li class="i">
	<div class="form_ul_div clear info">
		<span class="title">样式名称: </span>
		<input type="text" name="starname"  value="{$starname}" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
		<span class="title" >星星图标：</span>
			<div class="img-box">
				<div class="img">
					{if $star}
						<img  src="{$star}">
				...
				<input type="file" name="star"  style="display: none;" />
	...
	<div class="form_ul_div clear">
		...
		<span class="title" >月亮图标：</span>
			<div class="img-box">
				...
				<input type="file" name="moon"  style="display: none;" />
				<div class="img-upload-btn">+</div>
			</div>
			</div>
		</li>
	...
	<div class="form_ul_div clear">
		<span class="title" >太阳图标：</span>
			<div class="img-box">
				...
				<input type="file" name="sun"  style="display: none;" />
				<div class="img-upload-btn">+</div>
			</div>
			</div>
		</li>
