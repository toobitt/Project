...
<li class="common-list-data clear" _id="{$v['id']}" id="r_{$v['id']}" name="{$v['id']}"   orderid="{$v['order_id']}" >
    ...
    <div class="common-list-right">
        ...
        <div class="common-list-item wd120">
            <div class="common-list-cell">
                <a class="btn-box add-black-item" id="add-black_{$v['id']}" href="###" _identifier="{$v['identifier']}" _member_id="{$v['member_id']}" _device_token="{$v['device_token']}" _black_device="0" _deadline="0" _type="0">解封黑名单</a>
            </div>
        </div>
        {elseif $v['deadline'] == -1}
        <div class="common-list-item wd120">
            <div class="common-list-cell">
                <a class="btn-box add-black-item" id="add-black_{$v['id']}" href="###" _identifier="{$v['identifier']}" _member_id="{$v['member_id']}" _device_token="{$v['device_token']}" _black_device="1"  _deadline="-1" _type="2">加入永久黑名单</a>
            </div>
        </div>
        {else}
        <div class="common-list-item wd120">
            <div class="common-list-cell">
                <a class="btn-box add-black-item" id="add-black_{$v['id']}" href="###" _identifier="{$v['identifier']}" _member_id="{$v['member_id']}" _device_token="{$v['device_token']}" _black_device="1"  _deadline="-1" _type="1">加入App黑名单</a>
            </div>
        </div>
        {/if}
    ...
    <div class="common-list-biaoti" href="run.php?mid={$_INPUT['mid']}&a=form&id={$v['id']}&infrm=1">
        <div class="common-list-item biaoti-transition">
            ...
            <a>
                <span class="common-list-overflow  fz14 m2o-common-title" style="display:inline-block;width: 100px;overflow: inherit;">{$v['device_token']}</span>
            </a>
        </div>
    </div>
</li>