...
<div style="display:none">
	{template:unit/memberCreditRulesDiy_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6">新增自定义积分规则</a>
	</div>
</div>
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="所属应用">所属应用</div>
            <div class="m2o-item m2o-mark" title="积分规则">积分规则</div>
        ...
        <div class="m2o-each-list">
        	{if $list}
	        {foreach $list as $k => $v}
	        	{template:unit/memberCreditRulesDiylists}
	        {/foreach}
	        {else}
