...
function hg_change_a_state(id)
{
	$url = "run.php?mid="+gMid+"&a=audit&id="+id;
	hg_ajax_post($url);
}

function change_a_state_callback(obj)
{
	var obj = eval('('+obj+')');
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-right">
                                <div class="common-list-item wd100">停车场</div>
	                ...
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/announcement_list_item}
		                    {/foreach}
		                {else}
