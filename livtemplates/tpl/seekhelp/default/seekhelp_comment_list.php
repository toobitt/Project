...
<style>
.wd280{width:280px;max-width:280px;}
</style>
<div class="biaoz"  style="position:relative;z-index:1"  id="body_content">
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10"  href="./run.php?a=relate_module_show&app_uniq=seekhelp&mod_uniq=seekhelp&mod_a=show&_id={$_INPUT['_id']}&infrm=1" target="nodeFrame">
		<span class="left"></span>
		 <span class="middle"> <em class="add">查看互助</em></span>
                        ...
                        <li class="common-list-head public-list-head clear">
                            <div class="common-list-left">
                                <div class="common-list-item paixu">
			 	                   <a title="排序模式切换/ALT+R" onclick="hg_switch_order('comment_list');"  class="common-list-paixu"></a>
			                    </div>
                            </div>
                            <div class="common-list-right">
                                <div class="common-list-item wd60">编辑</div>
                                <div class="common-list-item wd60">删除</div>
                                <div class="common-list-item wd280">求助标题</div>
                                <div class="common-list-item wd60">状态</div>
                                <div class="common-list-item open-close wd120">会员/评论时间</div>
                            </div>
                            <div class="common-list-biaoti">
						        <div class="common-list-item">评论内容</div>
					        </div>
                        </li>
                    </ul>
	                <ul class="common-list hg_sortable_list public-list" id="comment_list" data-order_name="order_id" data-table_name="comment">
					    {if count($list[0]) > 0}
		       			    {foreach  $list[0]  as $k => $v}
		                      {template:unit/seekhelp_comment_item}
		                    {/foreach}
		                {else}
