...
$(function(){
	$('.add-black-item').click(function(){
		var target = $(this);
		var url = 'run.php?mid='+ gMid +'&a=black_seekhelp';
		var sort_id = target.attr('_sort_id');
		var app_id = target.attr('_app_id');
		var black_seekhelp = target.attr('_black_seekhelp');

		$.getJSON(url, {sort_id:sort_id,app_id:app_id,black_seekhelp:black_seekhelp}, function( json ){
			var obj = json[0];
			if(obj.deadline == -1)
			{
				$('#add-black_'+obj.sort_id).text("解封黑名单");
				target.attr('_black_seekhelp',0);
			}
			else if(obj.deadline == 0)
			{
				$('#add-black_'+obj.sort_id).text("加入黑名单");
				target.attr('_black_seekhelp',1);
			}
		});
	})
})
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-biaoti">
                                <div class="common-list-item wd180">用户名</div>
						        <div class="common-list-item wd180">APP名称</div>
						        <div class="common-list-item wd120">社区名称</div>
					        </div>
                        </li>
                    </ul>
