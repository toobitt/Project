...
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">分类名称：</span><input type="text" value='{$name}' name='sort_name' class="title">
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">分类描述：</span><textarea name="sort_desc">{$brief}</textarea>
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">父级分类：</span>
			...
			{/code}
		{template:unit/class,father_node_id,$fid,$node_data}
	</div>
</li>
</ul>
