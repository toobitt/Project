<?php
/* $Id: my_video.php 626 2011-09-08 03:30:00Z repheal $ */
?>
{template:head}
		...
		{if $video_info}
			...
			<tr height="72px" id="video_info_{$v['id']}" align="center" class="video_list">
				...
				{else}
					...
					<td>
					<div style="padding:0 5px;"><span class="delete_button" onclick="show_delete(this , {$v['id']})">删除</span> | <a href="javascript:void(0);" onclick="preview_video({$v['id']});" >预览 </a> 
					{$tong}
					</div>
					</td> 
				{/if}
