<?php 
/* $Id: station_play.php 8345 2012-03-20 05:51:09Z repheal $ */
?>
{template:head}
<div class="station">
  <div class="gtop">
	...
	{/if}
	<h1 class="subsub" id="vedio_name_container">{$station['web_station_name']}</h1>
  ...
  <div class="gtv" id="gtv">
   ...
   {else}
    ...
    <div class="tv">
		<div id="container">
			<div id="player"></div><div id="info"></div>
		</div>
    </div>
