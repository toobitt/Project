<?php 
/* $Id: video_play.php 7567 2012-01-13 09:16:08Z lixuguang $ */
?>
{template:head}
<div class="gareas">
  ...
  <div class="gtv">
   <div class="gtg"><iframe src="http://www.rdxmt.com/boke/rightad.php"  frameborder="no" border="0" scrolling="no" width="235" height="425"></iframe></div>
    <div class="tv">
      <div class="tv_video"><div id="player"></div></div>
    </div>
    <div class="tvt"><iframe src="http://www.rdxmt.com/boke/leftad.php"  frameborder="no" border="0" scrolling="no" width="235" height="425"></iframe></div>
    <div class="tv_vidtt">
        <div class="tv1">
...
<div class="garea">
    ...
    <div class="gright">
       ...
       <div class="gsub1"><img src="<?php echo RESOURCE_DIR;?>img/hcar_1.gif" width="19" height="28" /></div>
        ...
        <div class="gsub3"><img src="<?php echo RESOURCE_DIR;?>img/hcar_4.gif" width="7" height="28" /></div>
        <div class="gsub4_2"><iframe  frameborder="no" border="0" src="http://www.rdxmt.com/folder3/boke/tags/" scroll="no" height="60" width="399"></iframe></div>
    </div>
</div>
