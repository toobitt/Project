<li class="common-list-data clear"  id="r_{$v['id']}"    name="{$v['id']}"   orderid="{$v['order_id']}" >
    ...
    <div class="common-list-right">
        ...
        <div class="common-list-item circle-tjr">
            <div class="common-list-cell">
                <span>{$v['delivery_category_title']}</span>
            </div>
        </div>
        
        <div class="common-list-item circle-tjr">
            <div class="common-list-cell">
                <span>{$v['province_title']}</span>
            </div>
        </div>
        <div class="common-list-item circle-tjr">
            <div class="common-list-cell">
                <span>{$v['delivery_fee']}</span>
            </div>
        </div>        
    ...
    <div class="common-list-biaoti">
        <div class="common-list-item  biaoti-transition">
            <div class="common-list-cell">
                ...
                <!--<a href="./run.php?mid={$relate_module_id}&a=show&{$cate_type}={$v['id']}&infrm=1">-->
                {$v['province_title']}
                <!--</a>-->
                </span>
            </div>
