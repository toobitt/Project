			...
			{if $_INPUT['id']}
				<h2>编辑景区分类信息</h2>
					<ul class="form_ul">
						<li class="i">
							<div class="form_ul_div">
								<span  class="site_title">景区分类名：</span>
								<input type="text" value="{$list['name']}" name='name' style="width:440px;">
							</div>
						</li>
						<li class="i">
							<div class="form_ul_div">
								<span  class="site_title">景区分类描述：</span>
					...
					<ul class="form_ul">
						<li class="i">
							<div class="form_ul_div">
								<span  class="title" style="width:120px;">景区分类名：</span>
								<input type="text" value="{$list['name']}" name='name' style="width:440px;">
							</div>
						</li>
						<li class="i">
							<div class="form_ul_div">
								<span  class="title" style="width:120px;">景区分类描述：</span>
								<input type="text" value="{$list['brief']}" name='brief' style="width:440px;">
							</div>
						</li>
					</ul>-->
