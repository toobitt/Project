<?php 
/* 
$Id:photoedit_list.php 17960 2013-03-21 14:28:00 jeffrey $ 
*/
?>
{template:head}
{code}
...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
	...
	<a class="blue mr10"  href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增图片</em></span>
	...
	<div class="f">
          <div class="right v_list_show">
			...
			<div class="list_first clear" id="list_head">
                   ...
                   <a style="width:150px;margin-top:8px;float:left;">主图预览</a>
				   <a style="width:200px;margin-top:8px;float:left;">图片名</a>
				   <a style="width:200px;margin-top:8px;float:left;">历史痕迹</a>
				   <a style="width:150px;margin-top:8px;float:left;">最新操作时间</a>
           ...
           <form method="post" action="" name="listform">
               <ul class="list common-list public-list hg_sortable_list" id="newslist" data-order_name="order_id">
					{if is_array($list) &&!empty($list) && count($list)>0}
						{foreach $list as $k => $v}
							{code}
							$v['imgurl'] = $v['host'].$v['dir'].$v['filepath'].$v['filename'];
