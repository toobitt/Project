          ...
          <div class="right v_list_show">
			...
			<div class="list_first clear"  id="list_head">
                    ...
                    <span class="right" style="width:330px;">  
                    	 <a class="fl" style="width:80px;">删除</a>  
                   	  	 <a class="fl" style="width:80px;">推送至</a>               
						 <a class="fl" style="width:120px;">添加人/添加时间</a>
                   </span>
                   <a class="title" style="margin-left:53px;margin-top:8px;">讨论名称</a>  
           </div>

           <form method="post" action="" name="listform">
               <ul class="list" id="vodlist">
					 {if is_array($topic_list) && !empty($topic_list) && count($topic_list)>0}
						{foreach $topic_list as $k => $v}		
		                     {template:unit/topiclist}
		                {/foreach}
					{else}
	           ...
	           <div class="bottom clear">
	               <div class="left" style="width:400px;">
	                   ...
	                   <a style="cursor:pointer;"  onclick="return hg_ajax_batchpost(this,'delete','删除',1,'topic_id','','ajax');" name="batdelete">删除</a>
	                   <!--
