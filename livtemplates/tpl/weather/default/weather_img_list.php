...
<script type="text/javascript">
	function del_img(id,type)
	{
		if(type==1)
		{
			...
			var url = "run.php?mid="+gMid+"&a=del_img&id="+id+"&type="+type;
			hg_ajax_post(url);
		}
		if(type==2)
		{
...
<body class="biaoz"  style="position:relative;z-index:1"  id="body_content">
	...
	<div id="hg_page_menu" class="head_op_program">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6" style="font-weight:bold;">上传天气图</a>
	</div>
				...
				<div class="search_a" id="info_list_search">
	                ...
	                <div class="list_first clear"  id="list_head">
                        ...
                        <span class="right" style="width: 740px">
                        	<a class="fl">系统图</a>
                        	<a class="fl" style="width:180px;">自定义图片</a>
                        	<a class="fl" style="width:180px;">背景图片</a>
                        	<a class="fl" style="width:120px">发布人/时间</a>
                        	<span>                      		
                        		<a class="fl">操作</a>
                        	</span>	
                        </span>
	                ...
	                <form method="post" action="" name="pos_listform">
		                <ul class="list" id="pic_list">
							{if $weather_img_list}
			       			    {foreach $weather_img_list as $k => $v}		       			    
			                      {template:unit/weather_img_list}
			                    {/foreach}
			  				{/if}
