<?php 
/* $Id: topic_list.php 9407 2012-05-22 04:50:54Z lijiaying $ */
?>
{template:head}
{js:mblog}
{css:vod_style}
...
<div class="wrap biaoz">
	...
	<form action="" method="post">
			...
			<div class="list_first clear"  id="list_head">
				...
				<span style="width:430px;margin-right: 32px;" class="right"><a class="fb">点滴</a><a class="ml" style="margin-left:32px;">分类</a><a class="ml" style="margin-left: 14px;width: 50px">相似话题</a><a class="fl" style="margin-left:21px;">操作</a><a class="zt" style="margin-left:-29px;">状态</a><a class="tjr">添加人/时间</a></span><a class="title" style="margin-left: 45px;">话题</a>
			</div>
			<ul class="list ui-sortable ui-sortable-disabled" id="status_list">
				{if $list}
					{foreach $list[0] as $k => $v}
						{template:unit/topic_list_list}
					{/foreach}
					<li class="clear"></li>
				{else}
