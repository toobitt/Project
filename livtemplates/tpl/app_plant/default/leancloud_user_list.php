          ...
          <div class="right v_list_show">
                <div class="search_a" id="info_list_search">
                  <form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
	                    <div class="right_1">
                            <a style="font-size: 15px;">*可以通过用户名搜索</a>
							<!--{template:form/search_source,date_search,$_INPUT['date_search'],$_configs['date_search'],$attr_date}
							{template:form/search_source,type,$_INPUT['type'],$_configs['identity_auth_type'],$type_source}
							{template:form/search_source,status,$_INPUT['status'],$_configs['identity_auth_status'],$status_source}-->
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-right">
                                ...
                                <div class="common-list-item wd60"></div>
                                <div class="common-list-item wd80">查看</div>
                                <div class="common-list-item wd80">用户名</div>
                                <div class="common-list-item open-close wd80">时间</div>
                            </div>
                            <div class="common-list-biaoti">
						        <div class="common-list-item">邮箱</div>
					        </div>
                        </li>
                    </ul>
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/leancloud_user_list_item}
		                    {/foreach}
		                {else}
