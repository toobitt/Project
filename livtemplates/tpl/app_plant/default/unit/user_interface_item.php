<li class="common-list-data clear" _id="{$v['id']}" id="r_{$v['id']}" order_id="{$v['order_id']}"  name="{$v['id']}" >
    <div class="common-list-left">
        ...
        <div class="vod-fengmian common-list-item wd60">
        		{code}
					$_url = '';
					if($v['img_info'] && is_array($v['img_info']))
					{
						$_url = hg_fetchimgurl($v['img_info'],40,30);
					}
				{/code}
    ...
    <div class="common-list-right">
        ...
        <div class="common-list-item wd60">
            <div class="common-list-cell">
                 <a class="btn-box" href="run.php?mid={$relate_module_id}&ui_id={$v['id']}&infrm=1&ui_name={$v['name']}">查看属性</a>
            </div>
        </div>
        
        <div class="common-list-item wd60">
            <div class="common-list-cell">
                 <a class="btn-box" href="run.php?mid={$_INPUT['mid']}&a=copy_attr&id={$v['id']}&infrm=1">复制属性</a>
            </div>
        </div>
