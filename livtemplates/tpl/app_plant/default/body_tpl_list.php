...
/*正文模板类型控件*/
$body_tpl_source = array(
	'class' => 'transcoding down_list',
	'show' => 'body_tpl_type_show',
	'width' => 104,/*列表宽度*/
	'state' => 0,/*0--正常数据选择列表，1--日期选择*/
);
...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10"  href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增正文模板</em></span>
                ...
                <div class="search_a" id="info_list_search">
                  <form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
	                    <div class="right_1">
							...
							{template:form/search_source,type,$_INPUT['type'],$_configs['body_tpl_type'],$body_tpl_source}
							{template:form/search_source,status,$_INPUT['status'],$_configs['body_tpl_status'],$status_source}
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            <div class="common-list-left">
			                    ...
			                    <div class="common-list-item wd60">模板图</div>
                            </div>
                            <div class="common-list-right">
                                <div class="common-list-item wd60">查看</div>
                                <div class="common-list-item wd60">删除</div>
                                <div class="common-list-item wd60">类型</div>
                                <div class="common-list-item wd60">状态</div>
                                <div class="common-list-item open-close wd120">创建时间</div>
                            </div>
                            <div class="common-list-biaoti">
						        <div class="common-list-item">模板名</div>
					        </div>
                        </li>
                    </ul>
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/body_tpl_list_item}
		                    {/foreach}
		                {else}
