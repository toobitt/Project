...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
    <a class="blue mr10"  href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
    	...
    	<span class="middle"><em class="add">新增白名单</em></span>
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-right">
                                ...
                                <div class="common-list-item wd60">是否开启</div>
                                <div class="common-list-item wd60">调用层级</div>
                                <div class="common-list-item open-close wd120">创建时间</div>
                            </div>
                            <div class="common-list-biaoti">
						        <div class="common-list-item">域名</div>
					        </div>
                        </li>
                    </ul>
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/jssdk_white_list_item}
		                    {/foreach}
		                {else}
