                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-right" style="width:850px;">
                                ...
                                <div class="common-list-item wd80">应用版本</div>
                                <div class="common-list-item wd80">设备系统版本</div>
                                <div class="common-list-item wd80">设备平台</div>
                                <div class="common-list-item wd80">叮当版本</div>
                                <div class="common-list-item wd80">是否开发版</div>
                                <div class="common-list-item wd180">崩溃描述</div>
                                <div class="common-list-item open-close wd120">崩溃时间</div>
                            </div>
	                ...
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/crash_report_list_item}
		                    {/foreach}
		                {else}
