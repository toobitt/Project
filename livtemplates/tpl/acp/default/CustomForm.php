...
<li class="i">
    <div class="form_ul_div clear">
        <span class="title">客户名称：</span><input type="text" value='{$title}' name='title' class="title">
    </div>
</li>
<li class="i">
    <div class="form_ul_div clear">
        <span class="title">客户描述：</span><textarea name="brief">{$brief}</textarea>
    </div>
</li>

<li class="i">
    <div class="form_ul_div clear">
        <span class="title">客户官网：</span><input type="text" value='{$url}' name='url' class="title">
    </div>
</li>
