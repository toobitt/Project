...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}&ac=add&site_id={$_INPUT['site_id']}" target="nodeFrame">
                        ...
                        <li class="common-list-head clear">
                            <div class="common-list-left">
                             ...
                             <div class="common-list-right">
                                ...
                                <div class="circle-tjr common-list-item open-close">根目录</div>
                                <div class="circle-tjr common-list-item open-close">上级目录</div> 
                                <div class="circle-tjr common-list-item open-close">所在目录</div>
                                <div class="circle-tjr common-list-item open-close">配置文件名</div>
                            </div>  
