    ...
    <div class="common-list-right">
        <div class="common-list-item circle-tjr">
            <div class="common-list-cell" style="width:72px;">
                <a title="详细" href="./run.php?mid={$_INPUT['mid']}&a=form&id={$v['id']}&infrm=1&ac=update">
                    <em class="b2" style="background-position: -60px -24px;width:16px;height:16px;margin:10px 0 0 0 ;"></em>
                </a>
    ...
    <div class="common-list-biaoti">
        <div class="common-list-item  biaoti-transition">
            <div class="common-list-cell">
                ...
                <a href="./run.php?mid={$relate_module_id}&a=show&custom_id={$v['id']}&infrm=1">
                {$v['title']}
                </a>
                </span>
            </div>
