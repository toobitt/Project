...
<div class="ad_middle">
	<form name="editform" onsubmit="return checknum()" id="editform"  action="./run.php?mid={$_INPUT['mid']}" method="post"  class="ad_form h_l">
		...
		<ul class="form_ul">
			...
			<li class="i">
				<div class="form_ul_div clear">
					<span class="title">话题组：</span>
					<input type="text" id="webmark" name="webmark"  value="{$group_name}" style="width:192px"/>
					<font class="important"></font>
				</div>
			</li>
			<li class="i">
				<div class="form_ul_div clear">
					...
					<input type="text" id="webappname" name="webappname"  value="{$tname}" style="width:192px"/>
					<font class="important"></font>
				</div>
			</li>
			<li class="i">
				<div class="form_ul_div clear">
					<span class="title">回帖人：</span>
					<input type="text" id="webappmark" name="webappmark"  value="{$user_name}" style="width:192px"/>
					<font class="important"></font>
				</div>
			</li>
			<li class="i">
				<div class="form_ul_div clear">
					...
					<input type="text" id="webappmark" name="webappmark"  value="{$pub_time}" style="width:192px"/>
					<font class="important"></font>
				</div>
			</li>
			<li class="i">
				<div class="form_ul_div clear">
					<span class="title">回帖内容：</span>
					<textarea rows="" cols="">{$pagetext}</textarea>
					<font class="important"></font>
				</div>
			</li>
		</ul>
