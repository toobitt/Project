...
<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
    <a class="add-button news mr10" href="run.php?mid={$_INPUT['mid']}&a=form&infrm=1">添加嘉宾</a>
</div>
</div>
        ...
        <ul class="common-list news-list">
            <li class="common-list-head public-list-head clear">
                ...
                <div class="common-list-right">
                    <div class="common-list-item open-close" style="width:450px;">嘉宾简介</div>
                ...
                <div class="common-list-biaoti">
                    <div class="common-list-item">嘉宾名称</div>
                </div>
            </li>
        </ul>
        <!-- 主题，记录的每一行 -->
...
<!-- 关于记录的操作和信息 -->
{template:unit/record_edit_guest}
<script>
</script>
{template:foot}     				