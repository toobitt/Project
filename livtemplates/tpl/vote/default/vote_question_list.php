...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="formwin">
		...
		<span class="middle"><em class="add">新增投票</em></span>
                   ...
                   <ul class="common-list public-list-head" id="list_head">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                                <div class="common-list-item fbz overflow common-list-pub-overflow">发布至</div>
<!--                                 <div class="common-list-item open-close wd60">操作</div> -->
                                
                                <div class="common-list-item open-close wd70">状态</div>
                                
                                 <div class="common-list-item open-close ">开启/关闭</div>
                                 <div class="common-list-item open-close ">投票总数</div>
                                <div class="common-list-item open-close ">分类</div>
                                <div class="common-list-item open-close " style="width:60px">权重</div>
                                
                             <!--  <div class="common-list-item open-close vote-xxs wd100">最少/最多(选项数)</div>
                                <div class="common-list-item open-close wd60">投票总数</div> -->  
                                <div class="common-list-item open-close vote-jssj wd80">截止时间</div>
                                
                                <div class="common-list-item open-close vote-tjr wd120">添加人/时间</div>
                            </div>
                            <div class="common-list-biaoti ">
						        <div class="common-list-item open-close vote-biaoti">标题</div>
					        </div>
                        </li>
                    </ul>
	           ...
	           <ul class="common-list">
				     <li class="common-list-bottom clear">
	                   ...
	                   <input type="checkbox"  name="checkall"  value="infolist" title="全选" rowtag="LI" />
	                	...
	                	<a onclick="return hg_ajax_batchpost(this, 'audit', '审核', 1, 'id', '&audit=0', 'ajax', 'hg_change_status');" name="audit">审核</a>
						<a onclick="return hg_ajax_batchpost(this, 'audit', '打回', 1, 'id', '&audit=1', 'ajax', 'hg_change_status');" name="back">打回</a>
						<a onclick="return hg_ajax_batchpost(this, 'delete', '删除', 1, 'id', '', 'ajax');" name="delete">删除</a>
