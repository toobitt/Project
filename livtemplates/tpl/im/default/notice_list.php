...
<div style="display:none">
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
			...
			<span class="middle"><em class="add">新增通知</em></span>
			<span class="right"></span>
		</a>
	</div>
</div>
<div class="common-list-content" style="min-height:auto;min-width:auto;">
    {template:unit/noticesearch}
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-name w120" title="接收人">接收人</div>
            <div class="m2o-item m2o-state w120" title="消息状态">消息状态</div>
            <div class="m2o-item m2o-audit w120" title="通知类型">通知类型</div>
            <div class="m2o-item m2o-style w120" title="审核状态">审核状态</div>
            <div class="m2o-item m2o-time" title="发送人/发送时间">发送人/发送时间</div>
        </div>
