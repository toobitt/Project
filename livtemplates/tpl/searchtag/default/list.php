...
.news-time{color:#888;font-size:10px;-webkit-text-size-adjust:none;}   
</style>
<!-- 这一部分会被推进父层框架，成为检索条件和添加、配置按钮 -->
<div {if $_INPUT['infrm']}style="display:none"{/if}>
    {template:unit/tag_search}
        ...
        <ul class="common-list news-list">
            <li class="common-list-head public-list-head clear">
                ...
                <div class="common-list-right">
                    <div class="common-list-item open-close wd70">应用</div>
                    <div class="common-list-item open-close wd70">模块</div>
