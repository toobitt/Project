...
<div class="login-wrap">
                ...
                <ul>
					 ...
					 {/if}	
                      ...
                      {/if}
                       ...
                       <input type="hidden" value="{$_INPUT['iscj']}" name="iscj" />
                       	<!--密保卡坐标隐藏域 -->
 ...
 <div class="login-footer">
       <span class="m2o-logo"></span>新媒体综合运营平台 {$_settings['version']}
       <!--<span class="hoge-logo"></span>出品-->
       <span class="license-logo"></span>授权使用：{$_settings['license']}
  </div>

<script>
var iscj = parseInt('{$_INPUT["iscj"]}');
var queryString = "{code}echo $_SERVER['QUERY_STRING'] ? $_SERVER['QUERY_STRING'] : ''; {/code}";
jQuery(function($){
    if(iscj){
