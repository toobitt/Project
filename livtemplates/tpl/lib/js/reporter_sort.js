jQuery(function($){
    var url = './run.php?mid='+ gMid +'&a=form&infrm=1&trigger_action=manage&trigger_mod_uniqueid=reporter_node&id=';
    var ajax = '_fetch_node.php?multi=reporter_node&fid={{fid}}&ban=1&trigger_action=show&trigger_mod_uniqueid=reporter_node';
    var createUrl = './run.php?mid='+ gMid +'&a=create&trigger_action=manage&trigger_mod_uniqueid=reporter_node';
    var sortUrl = './run.php?mid='+ gMid +'&a=sort&trigger_action=manage&trigger_mod_uniqueid=reporter_node';
    var deleteUrl = './run.php?mid='+ gMid +'&a=delete&trigger_action=manage&trigger_mod_uniqueid=reporter_node&id=';
    ...
    $('.column-delete-button').on('click', function(){
        ...
        jConfirm('确定删除？', '删除提示', function(result){
            if(result){
                $.post(deleteUrl + deleteId, function(){
