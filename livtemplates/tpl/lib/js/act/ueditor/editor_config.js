...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"php/myImageUp.php"           //图片上传提交地址
        ...
        ,toolbars:[["Bold","Underline","StrikeThrough","|","JustifyLeft","JustifyCenter","JustifyRight","|","InsertOrderedList","InsertUnorderedList","BlockQuote","|","InsertImage","Link","Unlink","|","PageBreak","|","Source","HighlightCode","|","FullScreen"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'bold':'','underline':'','strikethrough':'','|':'','justifyleft':'','justifycenter':'','justifyright':'','|':'','insertorderedlist':'','insertunorderedlist':'','blockquote':'','|':'','insertimage':'','link':'','unlink':'','|':'','pagebreak':'','|':'','source':'','highlightcode':'','|':'','fullscreen':''}
