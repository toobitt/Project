...
( function($){
	...
	window.ConfigData = {
		lottery_url : './run.php?mid=' + gMid + '&a=lottery',
		send_lottery_url : './run.php?mid=' + gMid + '&a=update_win_info',
		send_address_url : './run.php?mid=' + gMid + '&a=update_address',
		userInfo : null,
		systemInfo : null
	};
	...
	hg_Lottery.prototype={
		...
		getUserInfo : function(){
			...
			//data.device_token = config.systemInfo ? config.systemInfo.device_token : 123;
			data.version = config.systemInfo ? config.systemInfo.program_version : 2;
			//data.access_token = '4e66126a10643e4c443dbbc0baa87766';
			return data;
		},
		/*关闭中奖信息弹窗*/
