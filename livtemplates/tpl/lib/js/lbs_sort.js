jQuery(function($){
    var url = './run.php?mid='+ gMid +'&a=form&infrm=1&trigger_action=manage&trigger_mod_uniqueid=lbs_node&id=';
    var ajax = '_fetch_node.php?multi=lbs_node&fid={{fid}}&ban=1&trigger_action=show&trigger_mod_uniqueid=lbs_node';
    var createUrl = './run.php?mid='+ gMid +'&a=create&trigger_action=manage&trigger_mod_uniqueid=lbs_node&ajax=1';
    var sortUrl = './run.php?mid='+ gMid +'&a=sort&trigger_action=manage&trigger_mod_uniqueid=lbs_node';
    var deleteUrl = './run.php?mid='+ gMid +'&a=delete&ajax=1&trigger_action=manage&trigger_mod_uniqueid=lbs_node&id=';
