/*Copyright(c)2009,www.supersite.me*/
		window.iColorShow = function(id,id2, isHidden){
		...
		window.iColorPicker = function() {
		    jQuery("input.iColorPicker").each(function(i) {
		        ...
		        jQuery(this).css("backgroundColor", jQuery(this).val()).after('<a href="javascript:void(null)" id="icp_' + this.id + '" onclick="iColorShow(\'' + this.id + '\',\'icp_' + this.id + '\', \''+this.attributes['ishidden'].nodeValue+'\')"><img src="' + RESOURCE_URL + 'color.png" style="border:0;margin:0 0 0 3px" align="absmiddle" ></a>')
		    })
		};
