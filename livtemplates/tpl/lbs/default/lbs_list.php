...
<div style="display:none">
	{template:unit/lbs_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="formwin" class="button_6">新增信息点</a>
