...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10"  href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增大会嘉宾</em></span>
		            ...
		            <ul class="common-list public-list">
				     <li class="common-list-bottom clear">
					   <div class="common-list-left">
					       ...
					       <a style="cursor:pointer;"  onclick="return hg_ajax_post(this, '生成指南离线数据', 1);" href="./run.php?mid={$_INPUT['mid']}&a=create_guide_off_line" >生成指南离线数据</a>
					   </div>
		               {$pagelink}
		            </li>
		          	</ul>	
