					...
					<ul class="form_ul">
						...
						<li class="i">
							...
							<div class="form_ul_div" style="margin-left:75px;">
								<img src="{$_avatar}"  width="80px" height="60px" />
							</div>
						</li>
						...
						<li class="i">
							<div class="form_ul_div">
								...
								<input type="text" value="{$weibo}" name='weibo' style="width:257px;" />
							</div>
						</li>
						...
						<li class="i">
							<div class="form_ul_div">
								...
								<input type="text" value="{$url}" name='url' style="width:257px;" />
							</div>
						</li>
						
						<li class="i">
							<div class="form_ul_div">
								<span  class="title">对应分类ID</span>
								<input type="text" value="{$sort_id}" name='sort_id' style="width:257px;" />
							</div>
						</li>
					</ul>
