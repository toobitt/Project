...
<div class="info clear cz">
	<ul id="video_opration" class="clear" style="border:0;">
		<li>
			<a class="button_4" href="./run.php?mid={$_INPUT['mid']}&a=form&id={$formdata['id']}&maga_id={$formdata['magazine_id']}&infrm=1">编辑</a>
		</li>
		<li>
...
<div class="info clear vo">
	<h4 onclick="hg_slide_up(this,'video_subinfo')"><span title="展开\收缩"></span>期刊属性</h4>
	<ul id="video_subinfo" class="clear">
		<li class="h"><span>杂志名称：{$formdata['name']}</span></li>
		<li class="h"><span>期数：{$formdata['year']}年&nbsp;第{$formdata['issue']}期</span></li>
