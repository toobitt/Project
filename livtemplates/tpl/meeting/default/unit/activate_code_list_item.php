<li class="common-list-data clear" _id="{$v['id']}" id="r_{$v['id']}" name="{$v['id']}" >
    ...
    <div class="common-list-right">
        ...
        <div class="common-list-item wd100">
                {if $v['is_use']}<span style="color:blue;">是</span>{else}<span style="color:red;">否</span>{/if}
        </div>
    </div>
    <div class="common-list-biaoti" href="run.php?mid={$_INPUT['mid']}&a=form&id={$v['id']}&infrm=1">
        <div class="common-list-item biaoti-transition">
                <a>
	                <span class="common-list-overflow max-wd fz14 m2o-common-title" style="display:inline-block;">{$v['activate_code']}</span>
                </a>
        </div>
    </div>
</li>