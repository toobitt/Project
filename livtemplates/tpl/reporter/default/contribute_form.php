...
<div class="wrap clear"  >
			...
			<ul class="form_ul">
				...
				<li class="i">
					<div class="form_ul_div clear">
						...
						<input type="text" value="{$formdata['user_name']}" name="user_name"/>	
						<font class="important" style="color:red">若登陆后发报料，请勿填写报料人信息，此处只供未登陆用户使用</font>									
					</div>
				</li>
				<li class="i">
					<div class="form_ul_div clear">
				...
				<li class="i">
					<div class="form_ul_div clear">
						...
						<input type="text" value="{$formdata['addr']}" name="addr"/>					
					</div>
				</li>
				{if BOUNTY}
				{if $a=='update'}
				...
				<li class="i">
					<div class="form_ul_div clear">
						...
						<input type="text" value="{$formdata['money']}" name="money"/>					
					</div>
				</li>
				{/if}
				{/if}
	...
	<div id="hoge_edit_play" style="position:absolute;left:750px;top:-340px;dispaly:none">
		...
		<object id="video" type="application/x-shockwave-flash" data="{$markswf_url}vodPlayer.swf?{$formdata['time']}" width="320" height="270">
			...
			<param name="flashvars" value="jsNameSpace=adminDemandPlayer&startTime={$formdata['start']}&duration={$formdata['duration']}&videoUrl={$formdata['video_url'][0]['url']}&videoId={$formdata['video_url'][0]['vodid']}&snap=true&autoPlay=false&snapUrl={$formdata['snapUrl']}">
		</object>
		<span></span>
	</div>
	{/if}
