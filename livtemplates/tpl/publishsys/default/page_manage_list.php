...
<body class="biaoz"  style="position:relative;z-index:1"  id="body_content">
 {template:unit/temclassifysearch}
	    ...
	    <div class="column-box">
	        <div class="column-inner-box">
	            <div class="column-each">
	                ...
	                <ul class="column-ul">
	                    {foreach $page_manage_list as $kk => $vv}
	...
	<iframe id="column-iframe" src="" style="display:none;width:100%;height:100%!important;" scrolling="no" frameborder="0"></iframe>
	</div>
</body>
{template:foot}