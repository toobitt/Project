<?php 
/* $Id: head_redir.php 10335 2012-08-03 07:39:28Z repheal $ */
?>
...
<div class="registering">
	<div class="header">
        <h1><a href="{code} echo hg_build_link('index.php'); {/code}"><img src="./res/img/register-logo.jpg" width="290" height="86" alt="注册logo" /></a></h1>
	</div>