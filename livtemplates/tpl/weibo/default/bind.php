	...
	<div class="content_middle clear"> 
		...
		{template:unit/userset}
			...
			<form id="bind_form_{code} echo 1; {/code}" action="bind.php" action="post" style="float:left;display:inline">
				...
				<span style="display:inline-block;border:1px solid silver; margin:30px; padding:3px;"><a href="javascript:void(0);" onclick="setBind(1);"><img  src="{code} echo RESOURCE_DIR; {/code}img/sina-logo.png" /></a></span>											
			</form>
