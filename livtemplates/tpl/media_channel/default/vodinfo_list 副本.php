          ...
          <div class="right v_list_show">
                <div class="search_a" id="info_list_search">
                  <form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
                    <div class="right_1">
						<!--
						<div class="down_list sort">
							<span class="input_left"></span>
							<span class="input_right"></span>
							<span class="input_middle"><a><em></em><label id="display_search_status">媒资分类</label></a></span>
							<ul>
								<li><a onclick="hg_select_value(this,0);">网站节点</a></li>
								<li><a onclick="hg_select_value(this,0);">手机节点</a></li>
                ...
                <div class="list_first clear"  id="list_head">
                    	<span class="left"><a class="lb" style="cursor:pointer;"  {if $list && !$list[0]['colname']}onclick="hg_switch_order('vodlist');"{/if}  title="排序模式切换/ALT+R"><em></em></a><a class="slt">缩略图</a></span>
                        <span class="right" {if $_INPUT['node_type']}style="width:428px;"{else}style="width:370px;"{/if}>{if $_INPUT['node_type']}<a class="fb" style="width:49px;">发布栏目</a>{/if}<a class="fb">编辑</a><a class="ml">码流</a><a class="fl">分类</a><a class="zt">状态</a><a class="tjr">添加人/时间</a></span><a class="title">标题</a>
                </div>
                <form method="post" action="" name="listform">
                <ul class="{$vod_mode_class}" id="vodlist">
				    {if $list}
	       			    {foreach $list as $k => $v}
    		...
    		-->
                ...
                <div style="position:relative;">
                    <div id="open-close-box">
                        <span></span>
                        <ul>
                            <li which="vod-fabu"><label><input type="checkbox" checked/>发布至</label></li>
                            <li which="vod-maliu"><label><input type="checkbox" checked/>码流</label></li>
                            <li which="vod-fenlei"><label><input type="checkbox" checked/>分类</label></li>
                            <li which="vod-zhuangtai"><label><input type="checkbox" checked/>状态</label></li>
                            <li which="vod-ren"><label><input type="checkbox" checked/>添加人/时间</label></li>
                        </ul>
                    </div>
                </div>
                -->
                    ...
                    <ul class="vod-list common-list">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                                <div class="vod-fabu common-list-item open-close" which="vod-fabu">发布至<img class="common-head-drop" src="{$RESOURCE_URL}tuji/drop.png"/></div>
                                <div class="vod-maliu common-list-item open-close" which="vod-maliu">码流</div>
                                <div class="vod-fenlei common-list-item open-close" which="vod-fenlei">分类<img class="common-head-drop" src="{$RESOURCE_URL}tuji/drop.png"/></div>
                                <div class="vod-zhuangtai common-list-item open-close" which="vod-zhuangtai">状态</div>
                                <div class="vod-ren common-list-item open-close" which="vod-ren">添加人/时间<img class="common-head-drop" src="{$RESOURCE_URL}tuji/drop.png"/></div>
                            </div>
 ...
 function  hg_panduan(obj)
 {
		 ...
		 if(obj.status_data)
		 {
			 for(var i = 0;i<obj.status_data.length;i++)
			 {
				 ...
				 var  transize  = obj.status_data[i].transize;
				 var  totalsize = obj.status_data[i].totalsize;
				 var  speed     = obj.status_data[i].speed;
