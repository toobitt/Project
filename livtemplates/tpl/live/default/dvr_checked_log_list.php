<?php 
/* $Id: dvr_checked_log_list.php 17942 2013-03-12 06:04:53Z lijiaying $ */
?>
{template:head}
	...
	<div style="position: relative;">
		<div id="open-close-box">
			...
			<ul>
				...
				<li which="tjsj"><label><input type="checkbox" checked />添加人/时间</label></li>
			</ul>
		</div>
	</div>
		...
		<ul class="common-list">
			<li class="common-list-head public-list-head clear">
				...
				<div class="common-list-right">
					...
					<div class="common-list-item tjsj wd100">添加人/时间</div>
				</div>
