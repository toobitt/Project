                ...
                <div class="search_a" id="info_list_search">
                  <form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
	                    <div class="right_1">
							...
							{template:form/search_source,status,$_INPUT['status'],$_configs['push_msg_status'],$status_source}
                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-right">
                                ...
                                <div class="common-list-item wd180">消息</div>
                                <div class="common-list-item wd80">状态</div>
                                <div class="common-list-item open-close wd120">推送人/推送时间</div>
                            </div>
	                ...
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/push_msg_list_item}
		                    {/foreach}
		                {else}
