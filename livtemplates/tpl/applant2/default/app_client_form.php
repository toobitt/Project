	...
	<form name="editform" action="" method="post" class="ad_form h_l" onsubmit="return hg_form_check();" enctype="multipart/form-data">
		...
		<ul class="form_ul">
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						<span class="title">客户端名称：</span>
						<div class="input " style="width:345px;float: left;">
							<input type="text" name="client_name" id="client_name" value="{$name}" />
						</div>
			...
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						<span class="title">客户端标识：</span>
						<div class="input " style="width:345px;float: left;">
							<input type="text" name="client_mark" id="client_mark" value="{$mark}" />
						</div>
						<span class="error" id="title_tips" style="display:none;"></span>
					</div>
				</div>
			...
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						<span class="title">打包地址：</span>
						<div class="input " style="width:345px;float: left;">
							<input type="text" name="client_url" id="client_url" style="width:330px;" value="{$url}" />
						</div>
						<span class="error" id="title_tips" style="display:none;"></span>
					</div>
				</div>
