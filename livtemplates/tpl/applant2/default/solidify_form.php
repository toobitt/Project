	...
	<form name="editform" action="" method="post" class="ad_form h_l" onsubmit="return hg_form_check();" enctype="multipart/form-data">
		...
		<ul class="form_ul">
				...
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						<div class="input " style="width:345px;float: left;">
							<input type="text" name="module_name" id="module_name" value="{$name}" /><span style="color:#F00; margin-left:10px;">*</span>
						</div>
			...
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						<div class="input " style="width:345px;float: left;">
							<input type="text" name="module_mark" id="module_mark" value="{$mark}" /><span style="color:#F00; margin-left:10px;">*</span>
						</div>
						<span class="error" id="title_tips" style="display:none;"></span>
					</div>
				</div>
			...
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						<span class="title">模块描述：</span>
						<textarea id="intro" name="module_brief">{$brief}</textarea>
			...
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						{if $pic}
						<img src="{code}echo hg_bulid_img($pic, 50, 50);{/code}" />
						{/if}
