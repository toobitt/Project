...
<div style="display:none">
	...
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="nodeFrame">
			...
			<span class="middle"><em class="add">新增内容模板</em></span>
...
<div id="add_question"  class="single_upload">
	...
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="logo/名称">模板名称</div>
            <div class="m2o-item m2o-style w150" title="标识">模板标识</div>
             <div class="m2o-item m2o-style w200" title="标题">邮件标题</div>
            <div class="m2o-item m2o-switch w120" title="状态">状态</div>
            <div class="m2o-item m2o-time" title="添加人/时间">添加人/时间</div>
        </div>
        <div class="m2o-each-list">
        	{if is_array($list) && count($list)>0}
				{foreach $list as $k => $v}	
		            {template:unit/email_content_template_list_list}
		        {/foreach}
			{else}
