...
$(function(){
	tablesort('vodlist','performances','order_id');
...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form&show_id={$_INPUT['show_id']}{$_ext_link}" target="nodeFrame">
		<span class="left"></span>
		<span class="middle"><em class="add">新增场次</em></span>
                 ...
                 <!--  <span class="serach-btn"></span> -->
                  <form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
                    <div class="select-search">
						...
						<input type="hidden" name="show_id" value="{$_INPUT['show_id']}" />
                    </div>
                    <!-- 
                   ...
                   <ul class="common-list public-list-head" id="list_head">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                            	<div class="common-list-item open-close wd80">总票数</div>
                            	<div class="common-list-item open-close wd120">剩余票数</div>
                            ...
                            <div class="common-list-biaoti ">
						        <div class="common-list-item open-close">演出时间</div>
					        </div>
                        </li>
                    </ul>
