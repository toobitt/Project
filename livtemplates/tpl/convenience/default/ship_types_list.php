...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		<span class="left"></span>
		 <span class="middle"><em class="add">新增船次</em></span>
		<span class="right"></span>
	</a>
		<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form_excel{$_ext_link}">
		<span class="left"></span>
		 <span class="middle"><em class="add">导入船次</em></span>
		<span class="right"></span>
	</a>
</div>
                    ...
                    <ul class="common-list">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-biaoti">
						        ...
						        <div class="common-list-item open-close group-title" style="width: 95px"></div>
						        <div class="common-list-item open-close group-title" style="width: 95px"></div>
...
{	 
	...
	{   
		$('.common-list-data').filter( function(){
			var name = $(this).attr('name'),
				decode_name = decodeURIComponent( name );
			return  ( name == ids[i] || decode_name == ids[i] );
		} ).remove();
