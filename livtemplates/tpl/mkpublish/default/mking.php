                   ...
                   <ul class="common-list" id="list_head">
                        <li class="common-list-head clear public-list-head">
                            ...
                            <div class="common-list-right"> 
                                <div class="common-list-item wd60">操作类型</div>
	                 ...
	                 <ul class="common-list public-list" id="tujilist">
					    {if $mking[0]}
		       			    {foreach $mking[0] as $k => $v} 
		                      {template:unit/mkinglist}
		                    {/foreach}
						{else}
		            ...
		            <ul class="common-list">
				      <li class="common-list-bottom clear">
						   <div class="common-list-left">
		                     ...
		                     <a style="cursor:pointer;"  href="./run.php?mid={$_INPUT['mid']}&a=delete_mk&type=all"    name="batdelete">清空全部</a>
					       </div>
		                  {$pagelink}
		               </li>
		            </ul>
