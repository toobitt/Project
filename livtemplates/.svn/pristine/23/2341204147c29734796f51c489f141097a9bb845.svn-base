...
<li class="i" id="datainput">
    <div class="form_ul_div clear">
        ...
        <input type="txt" name="start_time" class='input-item date-picker hasDatepicker' _time="true" value="{$start_time}"/>
    </div>
</li>
<li class="i" id="datainput">
    <div class="form_ul_div clear">
        <span class="title" >结束时间:</span>
        <input type="txt" name="end_time" class='input-item date-picker hasDatepicker' _time="true" value="{$end_time}"/>
    </div>
</li>

<input type="hidden" name="user_type" value="m2o" />
