<li class="common-list-data clear"  id="r_{$v['id']}"    name="{$v['id']}"   orderid="{$v['order_id']}" >
    ...
    <div class="common-list">
        <div class="common-list-item circle-tjr">
             <div class="common-list-cell">
           			<a title="详细" href="./run.php?mid={$_INPUT['mid']}&a=detail&id={$v['id']}&infrm=1"><em class="b2" style="background-position: -60px -24px;width:16px;height:16px;margin:10px 0 0 0 ;"></em></a>
