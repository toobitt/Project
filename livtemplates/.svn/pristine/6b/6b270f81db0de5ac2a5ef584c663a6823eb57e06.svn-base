...
{css:edit_video_list}
{css:column_form}
{js:publishsys/template_classify}
	    ...
	    <div class="column-box">
	        <div class="column-inner-box">
	            <div class="column-each">
	                <div class="column-add"><a class="column-sort-button" href="javascript:;"></a><span class="column-add-box"><a class="column-add-button" href="javascript:;"></a>添加模板分类</span></div>
	                <ul class="column-ul">
	                    {foreach $template_classify_list as $kk => $vv}
	...
	<div class="column-lujin-outer">
	    <div class="column-lujin-inner">
	        ...
	        <div class="column-lujin-content">
	            ...
	            <a class="column-delete-button" href="javascript:;">删除<span></span>模板分类</a>
	        </div>
	    </div>
	</div>
	</div>
