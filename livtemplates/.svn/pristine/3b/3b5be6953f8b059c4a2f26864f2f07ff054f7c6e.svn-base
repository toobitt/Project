...
<div style="display:none">
	{template:unit/medal_manage_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
	<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="formwin" class="button_6">新增勋章</a>
	</div>
</div>
	...
	<form action="" method="post">
	 <div class="m2o-list">
			...
			<div class="m2o-title m2o-flex m2o-flex-center">
		     ...
		     <div class="m2o-item m2o-image" title="勋章图标">勋章图标</div>
            <div class="m2o-item m2o-flex-one m2o-bt" title="勋章名称">勋章名称</div>
            <div class="m2o-item m2o-time" title="发放时间">发放日期</div>
            <div class="m2o-item m2o-used" title="已发放数量">已发放量</div>
        	<div class="m2o-item m2o-limit" title="总限制数量">总限制量</div>
        	<div class="m2o-item m2o-expiration" title="使用有效期">使用有效期</div>
        	<div class="m2o-item m2o-mark" title="发放方式">发放方式</div>
            <div class="m2o-item m2o-switch" title="是否启用">是否启用</div> 
        ...
        <div class="m2o-each-list">
        	{if $list}
	        {foreach $list as $k => $v}
	        	{template:unit/medal_managelist}
	        {/foreach}
	        {else}
