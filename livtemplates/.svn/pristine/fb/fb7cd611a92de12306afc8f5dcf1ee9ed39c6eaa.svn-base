		...
		<ul class="common-list news-list">
			<li class="common-list-head public-list-head clear">
				...
				<div class="common-list-right">
					<div class="common-list-item news-fabu common-list-pub-overflow" style="width:400px;">内容页地址</div>
		...
		<ul class="common-list public-list">
			<li class="common-list-bottom clear">
				<div class="common-list-left">
					...
					<!-- 以前的写的 <a style="cursor:pointer;" onclick="return hg_ajax_batchpost(this, 'publish', '签发', 1, 'id', '&audit=1', 'ajax');" name="publish">签发</a> -->
					<a style="cursor:pointer;" onclick="return hg_bacthmove_show(this,'gather_node');" data-node="gatherapi_node" name="publish">签发</a>
