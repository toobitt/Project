...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10" href="run.php?mid={$_INPUT['mid']}&a=form&infrm=1">
		...
		<span class="middle"><em class="add">添加餐馆</em></span>
		<span class="right"></span>
	</a>
	<a class="gray mr10" href="run.php?mid={$_INPUT['mid']}&a=configuare&infrm=1" target="mainwin">
		<span class="left"></span>
		<span class="middle"><em class="set">配置视频库</em></span>
		<span class="right"></span>
	</a>
</div>
                   ...
                   <ul class="common-list">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                                <div class="auth-logo common-list-item open-close">店家logo</div>
                                <div class="auth-district common-list-item open-close">所属地区</div>
                                <div class="auth-address common-list-item open-close">地址</div>
                                <div class="auth-link-man common-list-item open-close">联系人</div>
                            ...
                            <div class="common-list-biaoti">
						        <div class="common-list-item open-close auth-channel-name">餐馆名称</div>
					        </div>
                        </li>
                    </ul>
