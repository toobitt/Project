			        	...
			        	else
			        	{
				        	...
				        	if(id)
	        				{
					        	...
					        	else
				        		{
					        		if($("#collect_"+id).html())
				        			{
					        			li = '<a class="plays" href="'+SNS_VIDEO+'station_play.php?sta_id='+id+'"></a><a class="gz_del" href="javascript:void(0);" onclick="del_concern('+ obj.id +','+ id +','+ uid +',1);"></a>';
					        			$("#collect_"+id).html(li);
				        			}
					        		if($("#gz_"+id).html())
				        			{
				...
				$.ajax({
			        ...
			        success: function(json) {
			        	...
			        	else
			        	{
			        		...
			        		{
				        		li = '<a class="plays" href="'+SNS_VIDEO+'station_play.php?sta_id='+id+'"></a><a class="gz_get" href="javascript:void(0);" onclick="add_concern('+ cid +',1,'+ uid +');"></a>';
