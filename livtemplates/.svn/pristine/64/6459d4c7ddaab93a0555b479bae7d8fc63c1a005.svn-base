                   ...
                   <ul class="common-list" id="list_head">
                        <li class="common-list-head clear public-list-head">
                            ...
                            <div class="common-list-right"> 
                                <div class="common-list-item">发布人</div>
                                <div class="common-list-item wd150">发布时间</div>
                                <div class="common-list-item">操作类型</div>
	                 ...
	                 <ul class="common-list public-list" id="tujilist">
					    {if $mkpublish_plan[0]}
		       			    {foreach $mkpublish_plan[0] as $k => $v} 
		                      {template:unit/mkpublish_planlist}
		                    {/foreach}
						{else}
