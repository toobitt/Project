...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}&state=1" target="formwin">
		...
		<a type="button" class="button_6"  href="./run.php?mid={$_INPUT['mid']}&a=form&site_id={$_INPUT['site_id']}&infrm=1">新增模板</a>
 ...
 <div class="f">
	...
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-audit" title="状态">开启/关闭</div>
            <div class="m2o-item m2o-time" title="添加人/时间">添加人/时间</div>
        </div>
        <div class="m2o-each-list">
        	 {if $list[0]}
       	     {foreach $list[0] as $k => $v} 
                 {template:unit/xml_group_list_list}
             {/foreach}
			 {else}
        ...
        <div class="m2o-bottom m2o-flex m2o-flex-center">
    		...
    		<div class="m2o-item m2o-flex-one">
    		   ...
    		   <a class="batch-open" _open="1" style="padding-right: 10px;text-decoration: underline;cursor: pointer;">开启</a>
    		</div>
    ...
    <div class="m2o-option-inner m2o-flex">
        <div class="m2o-btns m2o-flex">
			<div class="m2o-btn-area m2o-flex">
				<a href="./run.php?mid={$_INPUT['mid']}&a=form&id={{= id}}&infrm=1&state=1" target="mianwin">编辑</a>
