...
.save{float:right;margin-top:10px;padding:0 40px;height:34px;background:#6EA5E8;line-height:34px;color:#fff;border:none;border-radius:2px;font-size:14px;cursor:pointer;}
...
<form method="post"  id="content_form">
	<table>
		...
		<tr class="title content">
			<td class="head">内容</td>
			<td>
					<script type="text/plain" id="editor" name="content">{$content}</script>
			</td>
		</tr>
		<tr class="title">
			...
			<td>
				<div>
					<input type="text" name="keyword" value="{$keyword}" class="keyword-area" />
