<li class="common-list-data clear"  id="r_{$v['id']}"    name="{$v['id']}"   orderid="{$v['order_id']}">
	...
	<div class="common-list-right">
       <div class="common-list-item auth-logo">
            <div class="common-list-cell">
                <span><img src="{$v['logo']}" width="40" height="30" /></span>
            </div>
       </div>
       
       <div class="common-list-item auth-district">
            <div class="common-list-cell">
                <span>{$v['district_name']}</span>
            </div>
       </div>
       
       <div class="common-list-item auth-address">
            <div class="common-list-cell">
                <span>{$v['address']}</span>
            </div>
       </div>
       
       <div class="common-list-item auth-link-man">
            <div class="common-list-cell">
                <span>{$v['linkman']}</span>
            </div>
       </div>
       
       <div class="common-list-item auth-telephone">
            <div class="common-list-cell">
                <span>{$v['tel']}</span>
            </div>
       </div>
