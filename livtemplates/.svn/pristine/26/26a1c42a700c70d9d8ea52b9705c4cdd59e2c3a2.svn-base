...
{js:column_node}
{js:iColorPicker}
<form action="" method="post" enctype="multipart/form-data" class="ad_form h_l" id="movie_node_form" name="movie_node_form" onsubmit="return hg_ajax_submit('movie_node_form');">
<ul class="form_ul">
	<li class="i">
