		...
		<form method="post" action="" name="listform" class="common-list-form">
				...
				<li class="common-list-data clear" id="r_{$v['id']}">
					...
					<div class="common-list-biaoti">
					   <div class="common-list-item biaoti-content biaoti-transition">
						<span class="common-list-overflow wd150"><a href="./run.php?mid={$relate_module_id}&bill_id={$v['id']}&locked={$v['locked']}&infrm=1" target="nodeFrame">{$server_item[$v['project_id']]}</a></span>
					  </div>
			...
			<ul class="common-list  public-list">
				<li class="common-list-bottom clear">
					...
					<a style="cursor:pointer;" onclick="return hg_ajax_batchpost(this, 'audit', '审核（审核后会被锁定）', 1, 'id', '&audit=1', 'ajax', 'hg_change_status');" name="audit">审核</a>
...
<div id="record-edit">
	<div class="record-edit">
		<div class="record-edit-btn-area clear">
			...
			<a href="./run.php?mid={$relate_module_id}&bill_id=${id}&infrm=1">进入记录</a>
