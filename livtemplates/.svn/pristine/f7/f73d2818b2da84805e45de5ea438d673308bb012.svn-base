...
<div class="content clear people" id="equalize">
	<div class="content-left">
		...
		{else}
		<div class="my-business">{$user_info['username']}有<span>{$user_info['followers_count']}</span>个粉丝</div>	
		{/if}		
			...
			{foreach $followers as $k => $v}	
				<li class="clear" id="delete_{$v['id']}">
					<div class="blog-content">
						...
						<span id="add_{$v['id']}"><a class="follow-gz" href="javascript:void(0);" onclick="addFriends({$v['id']} , 3)"></a></span> 
