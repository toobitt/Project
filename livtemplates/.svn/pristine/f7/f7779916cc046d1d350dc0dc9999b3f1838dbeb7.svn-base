...
<div class="gareas">
  ...
  <div class="gtv">
   <div class="gtg"><iframe src="http://www.ijntv.cn/ijntvad/bokeadl/index.html" border="0" scrolling="no" width="205" height="355"></iframe></div>
    <div class="tv">
      <div class="tv_video"><div id="tvie_flash_players"></div></div>
    </div>
    <div class="tvt"><iframe src="http://www.ijntv.cn/ijntvad/bokeadl/index.html" border="0" scrolling="no" width="205" height="355"></iframe></div>
    <div class="tv_vidtt">
        <div class="tv1">
...
<div class="garea">
    ...
    <div class="gright">
       ...
       <div class="gsub1"><img src="<?php echo RESOURCE_DIR;?>img/hcar_1.gif" width="19" height="28" /></div>
        ...
        <div class="gsub3"><img src="<?php echo RESOURCE_DIR;?>img/hcar_4.gif" width="7" height="28" /></div>
        <div class="gsub4_2"><iframe border="0" src="http://www.ijntv.cn/boke/tags/index.html" scroll="no" height="60" width="399"></iframe></div>
    </div>
</div>
