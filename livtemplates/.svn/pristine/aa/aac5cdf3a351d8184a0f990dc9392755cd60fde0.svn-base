	...
	<div class="wrap clear">
		<div class="ad_middle">
			<form name="block_data_form" action="" method="post"  class="ad_form h_l">
				...
				<input type="hidden" name="site_id" value="{$block_form[0]['site_id']}" />
				<input type="hidden" name="page_id" value="{$block_form[0]['page_id']}" />
				<input type="hidden" name="page_data_id" value="{$block_form[0]['page_data_id']}" />
				<input type="hidden" name="expand_name" value="{$block_form[0]['expand_name']}" />
				<br />
