...
<body class="biaoz"  style="position:relative;z-index:1"  id="body_content">
	<div id="hg_page_menu" class="head_op_program"{if $_INPUT['infrm']} style="display:none"{/if}>
		<a href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}&trigger_action=manage&trigger_mod_uniqueid=contribute_node" class="button_6" style="font-weight:bold;">添加分类</a>
	</div>
	<h2 class="title_bg">报料分类</h2>
