<?php 
/* 
$Id:updown_setting_list.php 17960 2013-03-21 14:28:00 jeffrey $ 
*/
?>
{template:head}
{code}
	...
	<div class="f">
          <div class="right v_list_show">
			...
			<div class="list_first clear" id="list_head">
                   ...
                   <a style="width:150px;margin-top:8px;float:left;">帖子名称</a>
				   <a style="width:150px;margin-top:8px;float:left;">帖子分类</a>
				   <a style="width:150px;margin-top:8px;float:left;">帖子作者</a>
