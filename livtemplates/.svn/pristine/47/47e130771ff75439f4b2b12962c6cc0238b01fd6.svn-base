<li class="clear"  id="r_{$v['id']}"    name="{$v['id']}"   orderid="{$v['order_id']}"  onmouseout="hg_row_interactive(this, 'out');" onmouseover="hg_row_interactive(this, 'on');">
	<span class="left">
		...
		<a class="fb overflow"  style="width:120px;"  id="contribute_sort_name_{$v['id']}" href="run.php?infrm=1&mid={$_INPUT['mid']}&fid={$v['id']}">{$v['name']}</a>
	</span>
	<span class="right" onclick="hg_row_interactive('#r_{$v[id]}', 'click', 'cur');"  style="width:225px;">

		<a class="fb" title="编辑" href="javascript:void(0)" onclick="return hg_showAddadminOrg({$v['id']})"><em class="b2" ></em></a>
