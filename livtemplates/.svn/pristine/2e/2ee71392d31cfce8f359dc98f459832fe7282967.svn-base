...
{code}
$list = $movie_person_list[0];
{/code}

<script>
gBatchAction['delete'] = "./run.php?mid=253&a=person_delete";
</script>

<body class="biaoz"  style="position:relative;z-index:1"  id="body_content">
	<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
		<span type="button" class="button_6" >
			<a href="./run.php?mid={$_INPUT['mid']}&a=person_detail&infrm=1&nav=1">
				<strong>新增人物</strong>
			</a>
		</span>
	</div>
					...
					<ul class="common-list">
						<li class="common-list-head clear">
							<div class="common-list-left">
								...
								<div class="common-list-item">人物名</div>
								<div class="common-list-item">人物类型</div>
								<div class="common-list-item">电影数</div>
