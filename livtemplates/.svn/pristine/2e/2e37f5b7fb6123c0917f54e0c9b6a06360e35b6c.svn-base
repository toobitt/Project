...
<div style="display:none">
	{template:unit/memberpurview_search}
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="分组名称">权限名称</div>
            <div class="m2o-item m2o-op" title="标识">标识</div>
            <div class="m2o-item m2o-mark" title="操作类型">操作类型</div>
        <!--  <div class="m2o-item m2o-time" title="添加人/时间">添加人/时间</div>-->
        </div>
        <div class="m2o-each-list">
        	{if $list}
	        {foreach $list as $k => $v}
	        {template:unit/memberpurviewlist}
	        {/foreach}
	        {else}
