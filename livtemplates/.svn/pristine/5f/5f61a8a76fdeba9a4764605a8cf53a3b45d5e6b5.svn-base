...
{code}
$attrs_for_edit = array('pub_url', 'status');
{/code}
...
<div class="controll-area fr mt5" id="hg_page_menu" style="display: none">
    <a  class="add-button news mr10" href="./run.php?mid={$_INPUT['mid']}&a=form&infrm=1">添加应用</a>
</div>
</div>
        ...
        <ul class="common-list news-list">
            <li class="common-list-head public-list-head clear">
                ...
                <div class="common-list-right">
                    <div class="common-list-item open-close wd100">应用标识</div>
                    <div class="common-list-item open-close wd100">支付方式</div>
                    <div class="common-list-item news-zhuangtai open-close wd60">状态</div>
                    <div class="common-list-item news-fenlei open-close wd120">添加人/时间</div>
                </div>
