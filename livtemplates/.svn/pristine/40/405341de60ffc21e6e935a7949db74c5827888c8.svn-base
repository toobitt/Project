...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}&ac=create" target="nodeFrame">
                ...
                <form method="post" action="" name="listform">
                        ...
                        <li class="common-list-head clear">
                            <div class="common-list-left">
                             ...
                             <div class="common-list-right">
                                ...
                                <div class="circle-tjr common-list-item open-close">开始时间</div>
                                <div class="circle-tjr common-list-item open-close">结束时间</div>  
                                <div class="circle-tjr common-list-item open-close">添加时间</div>                              
                            </div>  
                    ...
                    <ul class="common-list" id="contri_sortlist">
                        {if $list && is_array($list)}
                            {foreach $list as $k => $v} 
                              {template:unit/members_notice_row}
                            {/foreach}
                        {else}
