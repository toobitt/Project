...
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">圈子名称：</span><input type="text" value='{$name}' name='name' class="title">
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
...
<br />
<input type="submit" id="submit_ok" name="sub" value="{$optext}圈子" class="button_6_14"/><input type="button" value="取消" class="button_6_14" style="margin-left:28px;" onclick="javascript:history.go(-1);"/>
</form>
</div>
