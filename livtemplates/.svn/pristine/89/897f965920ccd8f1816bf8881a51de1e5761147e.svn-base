...
{if !ISIOS && !ISANDROID}
 ...
 {else}
<div id="phonehtmt5player"><video src="{$formdata['video_m3u8']}" width="400" height="330" controls="controls" autoplay="autoplay"></video></div>
  {/if}
...
<div class="info clear cz">
	<ul id="video_opration" class="clear" style="border:0;">
		<li>
			<a class="button_4" href="./run.php?mid={$_INPUT['mid']}&a=form&id={$formdata['id']}&infrm=1{if $formdata['frame_type']}&_type={$formdata['frame_type']}{/if}{if $formdata['frame_sort']}&_id={$formdata['frame_sort']}{/if}" target="mainwin">编辑</a>
		</li>
		<li>
		...
		<li style="clear:left;">
			{if $formdata['vod_leixing'] == 4}
				<a class="button_4" href="./run.php?mid={$_INPUT['mid']}&a=video_mark&id={$formdata['id']}{$_pp}" target="mainwin">重标注</a>
			{else}
				{if $formdata['status'] != 0 && $formdata['status'] != 4 && $formdata['status'] != -1}
				<a class="button_4" href="./run.php?mid={$_INPUT['mid']}&a=video_mark&id={$formdata['id']}{$_pp}" target="mainwin">标注</a>
				{/if}
			{/if}
		</li>
		{/if}
		...
		<li style="margin-left:4px;display:none;"><a class="button_6" href="javascript:void(0);" onclick="hg_showAddToCollect({$formdata['id']});">添加至集合</a></li>
		<!-- <li><a class="button_4" href="download.php?a=video&amp;api={$__api}&amp;f=vod_down.php&amp;id={$formdata['id']}&amp;title={$formdata['title']}">下载</a></li> -->
		{if $formdata['status'] != 0 && $formdata['status'] != 4 && $formdata['status'] != -1}
		<li><a class="button_4" href="{$formdata['download']}?id={$formdata['id']}&access_token={$_user['token']}">下载</a></li>
		{/if}
		{if $formdata['display_technical']}
		<li><a class="button_4" href="./run.php?mid={$_INPUT['mid']}&a=review&id={$formdata['id']}"  onclick="return hg_ajax_post(this, '技术审核', 0);" >{$formdata['technical_status']}</a></li>
		{/if}
	</ul>
</div>
