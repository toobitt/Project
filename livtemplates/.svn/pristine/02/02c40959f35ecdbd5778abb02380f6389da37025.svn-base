<li class="common-list-data clear" _id="{$v['id']}" id="r_{$v['id']}" name="{$v['id']}"   orderid="{$v['order_id']}" >
    ...
    <div class="common-list-right">
        ...
        <div class="common-list-item wd80 overflow">
                <span>{$v['pay_status_text']}</span>
        </div>
        <div class="common-list-item wd150 overflow">
                <span>{$v['open_time_text']}</span>
        </div>
        <div class="common-list-item wd150 overflow">
                <span>{$v['expire_time_text']}</span>
        </div>
    ...
    <div class="common-list-biaoti" href="run.php?mid={$_INPUT['mid']}&a=form&id={$v['id']}&infrm=1">
        <div class="common-list-item biaoti-transition">
                <a>
	                <span class="common-list-overflow max-wd fz14 m2o-common-title" style="display:inline-block;">{$v['auth_identifier']}</span>
                </a>
        </div>
    </div>
</li>