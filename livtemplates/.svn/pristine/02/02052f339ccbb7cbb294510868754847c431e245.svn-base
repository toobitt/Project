...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}&ac=add&custom_id={$_INPUT['custom_id']}" target="nodeFrame">
        <span class="left"></span>
        <span class="middle"><em class="add">新增客户站点</em></span>
                        ...
                        <li class="common-list-head clear">
                            <div class="common-list-left">
                             ...
                             <div class="common-list-right">
                                ...
                                <div class="circle-tjr common-list-item open-close">简述</div>
                                
                                <div class="circle-tjr common-list-item open-close">网址</div> 
                                <!--
                                <div class="circle-tjr common-list-item open-close">IP</div> 
                                <div class="circle-tjr common-list-item open-close">端口</div> 
