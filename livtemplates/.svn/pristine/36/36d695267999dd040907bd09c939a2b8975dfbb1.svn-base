...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}&ac=add" target="nodeFrame">
        ...
        <span class="middle"><em class="add">新增用户</em></span>
                        ...
                        <li class="common-list-head clear">
                            <div class="common-list-left">
                             ...
                             <div class="common-list-right">
                                ...
                                <div class="circle-tjr common-list-item open-close">客户简述</div>
                                <div class="circle-tjr common-list-item open-close">客户官网</div> 
