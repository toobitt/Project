...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="nodeFrame">
		...
		<span class="middle"><em class="add">新增推送</em></span>
						...
						<li class="common-list-head clear">
							<div class="common-list-left">
                             ...
                             <div class="common-list-right">
                            	<div class="caozuo common-list-item open-close">操作</div>
                            	<div class="circle-tjr common-list-item open-close">CDN类型</div>
                            	<div class="circle-tjr common-list-item open-close"  style="width:70px">消息</div>
