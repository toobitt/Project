...
$(function(){
	tablesort('vodlist','star','order_id');
...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="nodeFrame">
		...
		<span class="middle"><em class="add">新增明星</em></span>
                   ...
                   <ul class="common-list public-list-head" id="list_head">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                            	...
                            	<!-- <div class="common-list-item open-close wd80">演出数量</div> -->
                                
                                <div class="common-list-item open-close vote-tjr wd120">添加人/时间</div>
                            </div>
                            <div class="common-list-biaoti ">
						        <div class="common-list-item open-close vote-biaoti">明星名称</div>
					        </div>
                        </li>
                    </ul>
