...
<div style="display:none">
	...
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="nodeFrame">
			...
			<span class="middle"><em class="add">新增短信服务器配置</em></span>
...
<div id="add_question"  class="single_upload">
	...
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-state w120" title="余额">余额</div>
            <div class="m2o-item m2o-num w120" title="余额提醒数">余额提醒数</div>
        ...
        <div class="m2o-each-list">
        	{if is_array($list) && count($list)>0}
				{foreach $list as $k => $v}	
		            {template:unit/sms_server_list_list}
		        {/foreach}
			{else}
