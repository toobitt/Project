    ...
    <div class="common-list-right">
        <div class="common-list-item circle-tjr">
             <div class="common-list-cell" style="width:48px;">
             		<a title="查看该类别数据" href="./run.php?mid={$relate_module_id}&a=show&id={$v['id']}&infrm=1&tbname={$v['name']}">查看数据</a>
        ...
        <div class="common-list-item circle-tjr">
            <div class="common-list-cell">
                    <span><a href="./run.php?mid={$_INPUT['mid']}&a=tb_detail&tbname={$v['name']}&infrm=1">{$v['name']}</a></span>
            </div>
        </div>
        <div class="common-list-item circle-tjr">
            <div class="common-list-cell">
