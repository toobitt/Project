<li order_id="{$v['order_id']}" _id="{$v[$primary_key]}" class="common-list-data clear"  id="r_{$v[$primary_key]}" name="{$v['order_id']}" >
   ...
   <div class="common-list-right">
        <div class="common-list-item open-close" style="width:150px;">
            <span>{$v['file_name']}</span>
        </div>
        <div class="common-list-item open-close" style="width:100px;">
            <span>{$v['file_size']}</span>
        </div>
        <div class="common-list-item open-close" style="width:100px;">
            <span>{$v['space_time']}</span>
        </div>
        <div class="common-list-item open-close" style="width:100px;">
            <span>{$v['valid_time']}</span>
        </div>
        ...
        <div class="common-list-item wd100 news-ren open-close">
             ...
             <span class="news-time">{code} echo date('Y-m-d',$v['create_time']);{/code}</span>
        </div>
    </div>
