                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-right">
                            	<div class="common-list-item wd120">应用名称</div>
                                <div class="common-list-item wd60">查看</div>
                                <div class="common-list-item wd60">删除</div>
                                <div class="common-list-item wd80">申请类型</div>
	                ...
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/developer_auth_list_item}
		                    {/foreach}
		                {else}
							<p style="color:#da2d2d;text-align:center;font-size:20px;line-height:50px;font-family:Microsoft YaHei;">没有您要找的{$_configs['identity_auth_status'][$_INPUT['dev_status']]}内容！</p>
