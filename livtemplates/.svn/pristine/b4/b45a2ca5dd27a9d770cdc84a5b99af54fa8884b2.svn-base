...
<body class="biaoz"  style="position:relative;z-index:1"  id="body_content">
    <div id="hg_page_menu" class="head_op" >
	<a type="button" class="button_6"  href="./run.php?mid={$_INPUT['mid']}&a=plan_form&infrm=1" >新增计划</a>
</div>
                   ...
                   <ul class="common-list" id="list_head">
                        <li class="common-list-head clear public-list-head">
                            ...
                            <div class="common-list-right"> 
                                <div class="common-list-item wd150">生成时间</div>
                                <div class="common-list-item wd150">下次生成时间</div>
                                <div class="common-list-item wd150">状态</div>
                                <div class="common-list-item wd150">操作</div>
                                <div class="common-list-item">创建人</div>
                            </div>
	                 ...
	                 <ul class="common-list public-list" id="tujilist">
					    {if $m_plan[0]}
		       			    {foreach $m_plan[0] as $k => $v} 
		                      {template:unit/m_planlist}
		                    {/foreach}
						{else}
