...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}" target="nodeFrame">
		...
		<span class="middle"><em class="add">新增活动</em></span>
               ...
               <ul class="common-list public-list-head">
                    <li class="common-list-head clear">
                        ...
                        <div class="common-list-right">
                        	<div class="common-list-item open-close news-fabu wd80">活动日期</div>
							    ...
							    <div class="common-list-biaoti" style="cursor:pointer;"  onclick="hg_show_opration_info({$v['id']});">
							    	<div class="common-list-item biaoti-transition">
								        <div class="common-list-cell">
								        	 ...
								        	 <span id="title_{$v['id']}"  class="common-list-overflow m2o-common-title" style="max-width:350px;{if $v['address']}display:block;{/if}">{$v['act_name']}</span>
