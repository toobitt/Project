...
<li class="i" id="datainput">
    <div class="form_ul_div clear">
        ...
        <input type="txt" name="start_time" class='input-item date-picker hasDatepicker' _time="true"/>
    </div>
</li>
<li class="i" id="datainput">
    <div class="form_ul_div clear">
        <span class="title" >结束时间:</span>
        <input type="txt" name="end_time" class='input-item date-picker hasDatepicker' _time="true"/>
    </div>
</li>

<input type="hidden" name="user_type" value="members" />
