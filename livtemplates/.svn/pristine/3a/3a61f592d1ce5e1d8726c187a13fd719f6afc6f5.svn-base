    ...
    <div class="ad_middle">
        <form class="ad_form h_l" action="./run.php?mid={$_INPUT['mid']}" enctype="multipart/form-data" method="post"   id="content_form">
            ...
            <ul class="form_ul">
                ...
                <li class="i">
                    <div class="form_ul_div clear">
                        <span class="title">交易接口地址:</span><input type="text" value="{$pay_config['upmp_trade_url']}" name='pay_config[upmp_trade_url]' class="title">
                    </div>
                </li>
                <li class="i">
                    <div class="form_ul_div clear">
                        <span class="title">查询接口地址:</span><input type="text" value="{$pay_config['upmp_query_url']}" name='pay_config[upmp_query_url]' class="title">
                    </div>
                </li>
                <li class="i">
                    <div class="form_ul_div clear">
                        ...
                        <font class="important">例:http://218.2.102.114:233/livsns/api/hogeorder/notify/notify_url_union.php</font>
                    </div>
                </li>
                <li class="i">
                    <div class="form_ul_div clear">
                        <span class="title">前台通知地址:</span><input type="text" value="{$pay_config['mer_front_end_url']}" name='pay_config[mer_front_end_url]' class="title">
                    </div>
                </li>
                <li class="i">
                    <div class="form_ul_div clear">
