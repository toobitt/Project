...
<link rel="stylesheet" type="text/css" href="<?php echo CSS_FILE_URL; ?>applant2/node_drop.css" />
<link rel="stylesheet" type="text/css" href="<?php echo CSS_FILE_URL; ?>applant2/2013/iframe.css" />
<link rel="stylesheet" type="text/css" href="<?php echo CSS_FILE_URL; ?>applant2/vod_live.css" />
<link rel="stylesheet" type="text/css" href="<?php echo CSS_FILE_URL; ?>applant2/hg_sort_box.css" />
<link rel="stylesheet" type="text/css" href="<?php echo CSS_FILE_URL; ?>applant2/common/common_publish.css" />
...
<div class="been_marked_second">
	...
	<?php if($need_more){ ?>
	<div class="addMoreNode" data-total="<?php echo $hg_data[0]['total'];?>" data-fid="<?php echo $hg_data[0]['fid'];?>">展开更多<span class="addMoreNode-icon"></span><img class="addMoreNode-loading" src="<?php echo $RESOURCE_URL;?>loading2.gif" /></div>
	<?php } ?>
</div>
						</div>
					</div>
