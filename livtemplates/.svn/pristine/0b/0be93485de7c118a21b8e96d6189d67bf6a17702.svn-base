...
<body class="{$bodyClass}" id="tishi-body">
	<header class="header">
		<div class="wrap">					
	...
	<section class="wrap">
	<div class="gtotal"><span class="gtotal_m"><a href="#">{$member_total}&nbsp;会员</a></span><span class="gtotal_a"><a href="activitys.php">{$action_total}&nbsp;行动</a></span><span class="gtotal_g"><a href="groups.php">{$group_total}&nbsp;圈子</a></span></div>