          ...
          <div class="right v_list_show">
           ...
           <form method="post" action="" name="listform">
               <ul class="list" id="vodlist">
               		{code}
               		{/code}
					 {if is_array($team_list) &&!empty($team_list) && count($team_list)>0}
						{foreach $team_list as $k => $v}		
		                     {template:unit/teamlist}
		                {/foreach}
					{else}
	           ...
	           <div class="bottom clear">
	               <div class="left" style="width:400px;">
	                   ...
	                   <a style="cursor:pointer;"  onclick="return hg_ajax_batchpost(this,'delete','删除',1,'team_id','','ajax');" name="batdelete">删除</a>
	                   <!--
