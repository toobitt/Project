			...
			<ul class="common-list">
				<li class="common-list-head public-list-head clear">
					...
					<div class="common-list-biaoti">
						<div class="common-list-item" style="width:150px;">所有者</div>
						<div class="common-list-item" style="width:150px;">所属项目</div>
						<div class="common-list-item" style="width:150px;">项目备注</div>
						<div class="common-list-item" style="width:80px;">状态</div>
						<div class="common-list-item" style="width:80px;">详情</div>						
				    </div>
				</li>
			</ul>
				...
				<li class="common-list-data clear" id="r_{$v['id']}">
					...
					<div class="common-list-biaoti">
					   <div class="common-list-item biaoti-content biaoti-transition">
						<span class="common-list-overflow wd150">{$v['bill']['user_name']}</span>
					  </div>
					  <div class="common-list-item">
					  	<span class="common-list-overflow  wd150">{$v['bill']['project_name']}</span>
					  </div>
					  <div class="common-list-item">
					  	<span class="common-list-overflow  wd150">{$v['bill']['cause']}</span>
					  </div>
					  ...
					  <div class="common-list-item">
					  	<span class="common-list-overflow wd80"><a href="./run.php?mid={$relate_module_id}&bill_id={$v['bill_id']}&infrm=1&noaction=1" target="nodeFrame">进入</a></span>
					  </div>					  
					</div>
...
<div id="record-edit">
	<div class="record-edit">
		<div class="record-edit-btn-area clear">
			...
			<a href="./run.php?mid={$relate_module_id}&bill_id={$v['id']}&infrm=1&noaction=1">进入记录</a>
