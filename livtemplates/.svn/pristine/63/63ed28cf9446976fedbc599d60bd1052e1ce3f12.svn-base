...
<div class="m2o-each m2o-flex m2o-flex-center" id="{$v['id']}" name="{$v['id']}" data-id="{$v['id']}">
	...
	<div class="m2o-item m2o-item-right dx">{code}echo hg_cutchars($v['photo_name'], 10);{/code}</div>
	<div class="m2o-item m2o-item-right m2o-state" data-method="audit" style="color:{$_configs['status_color'][$v['state']]}">{$status}</div>
