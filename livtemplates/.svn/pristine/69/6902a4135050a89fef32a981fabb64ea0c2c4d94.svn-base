...
{css:edit_video_list}
{code}
if(!isset($_INPUT['share_plat']))
{
    $_INPUT['share_plat'] = 'all';
}
{/code}
<script>
...
<form action="" method="POST" name="add_column" id="add_column">
	<span type="button" class="button_6"  onclick="formsubmit('add_column')">新增栏目</span>
          ...
          <div class="right v_list_show">
                <div class="search_a" id="info_list_search">
                  <form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
                    <div class="right_1">
						...
						{/code}
						{template:form/search_source,share_plat,$_INPUT['share_plat'],$share_arr,$attr_share}
                ...
                <div class="list_first clear"  id="list_head">
                    	<span class="left">
                    		...
                    		<a class="tjr">栏目名称</a>
                    		<a class="column_slt">栏目链接</a>
                    		</span>
                        <span class="right"><a class="fb">编辑</a><a class="fb">删除</a><a class="zt">状态</a><a class="tjr">添加时间</a></span>
                </div>
                <form method="post" action="" name="listform">
	                <ul class="list" id="tujilist">
					    {if $column[0]['column']}
		       			    {foreach $column[0]['column'] as $k => $v} 
		                      {template:unit/columnlist}
		                    {/foreach}
						{else}
						<p style="color:#da2d2d;text-align:center;font-size:20px;line-height:50px;font-family:Microsoft YaHei;">没有栏目！</p>
