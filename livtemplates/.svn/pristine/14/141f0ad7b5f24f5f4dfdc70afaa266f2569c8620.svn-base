          ...
          <div class="right v_list_show">
                ...
                <div class="list_first clear"  id="list_head">
                    <span class="left">
                    	...
                    	<a class="fl" style="width:60px">队列ID</a>
                    	<a class="shareslt">内容标题</a>
                    </span>
                    <span class="right">
                        <a class="fl">操作</a>
                        <a class="zt">状态</a>
                ...
                <form method="post" action="" name="listform">
	                <ul class="list" id="tujilist">
					    {if $list}
		       			    {foreach $list as $k => $v} 
		                      {template:unit/specialquelist}
		                    {/foreach}
						{else}
						<p style="color:#da2d2d;text-align:center;font-size:20px;line-height:50px;font-family:Microsoft YaHei;">没有专题队列！</p>
						<script>hg_error_html(specialquelist,1);</script>
		  				{/if}
