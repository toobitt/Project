...
<div id="hg_page_menu" class="head_op"{if $_INPUT['infrm']} style="display:none"{/if}>
	...
	<!--<a class="blue mr10"  href="?a=relate_module_show&app_uniq=program_record&mod_uniq=program_record_log&mod_a=show&infrm=1&channel_id={$_INPUT['channel_id']}">
		<span class="left"></span>
		<span class="middle"><em class="set">收录日志</em></span>
		<span class="right"></span>
	</a>
	
<a class="blue mr10"  href="?a=relate_module_show&app_uniq=program_record&mod_uniq=program_record_server&mod_a=show&infrm=1">
		<span class="left"></span>
		<span class="middle"><em class="set">服务器</em></span>
		<span class="right"></span>
	</a>
-->
</div>
