			...
			<li class="i">
				...
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						<span class="error" id="title_tips" style="display:block;">*不填写默认为:客车</span>
					</div>
				</div>
			</li>
						<li class="i">
				...
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						<span class="error" id="title_tips" style="display:block;">*不填写默认为上车站</span>
					</div>
				</div>
			</li>
					<li class="i">
