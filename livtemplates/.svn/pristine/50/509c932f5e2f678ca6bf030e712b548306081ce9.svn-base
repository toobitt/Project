...
<div  id="updatelist"  name="updatelist" class="clear" >
 <form action="./run.php?mid={$_INPUT['mid']}" method="post" enctype="multipart/form-data" name="water_form"  id="water_form"  onsubmit="return  hg_ajax_submit('water_form')">
	<div class="right clear" style="overflow:hidden;">
       <div class="bg_middle">
           <h2>水印配置</h2>
           <div class="water_type" style="display:none;">
		   		<input type="checkbox" value="1" checked="checked"  style="float:left;margin-top:8px;" id="select_type_1" name="image_type" onclick="hg_select_type(this,1);" />
		   		<div style="float:left;margin-top:10px;margin-left:10px;cursor:pointer" onclick="hg_select_type('#select_type_1',1)">图片</div>
		   		<input type="checkbox" value="1"  style="float:left;margin-top:8px;margin-left:10px;"  id="select_type_0" name="text_type" onclick="hg_select_type(this,0);" />
		   ...
		   <div class="water_type"  name="pic_config">
		   		...
		   		<div class="left_title" style="margin-top:11px;width:200px;">
		   		   ...
		   		   <input type="text" name="width" value="{$list['width']}" class="wfl" style="width:30px;margin-left:2px;height:14px;" onblur="hg_check_val(this,1);" />
		   		...
		   		<div class="left_title" style="margin-top:11px;width:200px;">
		   		   ...
		   		   <input type="text" name="height" value="{$list['height']}" class="wfl" style="width:30px;margin-left:2px;height:14px;" onblur="hg_check_val(this,2);"  />
		   		    <label class="wfl lab">px</label>
		   ...
		   <div class="water_type"  name="pic_config">
		   		...
		   		<input type="text" name="margin" value="{$list['margin']}" class="wfl" style="width:30px;margin-left:2px;height:14px;margin-top:13px;"  onblur="hg_check_val(this,3);"  />
		   ...
		   <div class="water_type"  name="text_config" style="display:none;">
		   		...
		   		<input type="text" id="water_color" name="water_color" value="{$list['water_color']}" class="wfl" style="width:100px;margin-left:2px;height:14px;margin-top:13px;"  />
		   </div>
		   ...
		   <div class="water_type"  style="height:206px;margin-top:10px;" name="pic_config">
		   		...
		   		<div id="water_preview" class="img_preview">
		   			<img src="{if $list['water_pic']}{$list['water_pic']}{else}{$resource_url}hill.png{/if}" width="100%" height="100%" id="img_preview" />
		   		</div>
		   </div>
		   ...
		   <div class="water_type"  style="height:30px;margin-top:10px;border:0px;">
				...
				<input type="hidden" name="a" value="save_water_config" />
