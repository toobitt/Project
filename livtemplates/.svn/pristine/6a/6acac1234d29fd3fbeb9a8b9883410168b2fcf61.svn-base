...
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">标题：</span><input type="text" id="act_name" value='{$act_name}' name='act_name' class="title" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">活动时间：</span><input type="text" id="act_date" value='{$act_date}' name='act_date' class="title" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">主办方：</span><input type="text" id="host" value='{$host}' name='host' class="title" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">费用：</span><input type="text" id="fee" value='{$fee}' name='fee' class="title" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
...
<li class="i">
	<div class="form_ul_div clear">
		<span class="title">活动地点：</span><input type="text" id="address" value='{$address}' name='address' class="title" />
	</div>
</li>
<li class="i">
	<div class="form_ul_div clear">
...
<br />
<input type="submit" id="submit_ok" name="sub" value="{$optext}活动" class="button_6_14"/><input type="button" value="取消" class="button_6_14" style="margin-left:28px;" onclick="javascript:history.go(-1);"/>
</form>
</div>
