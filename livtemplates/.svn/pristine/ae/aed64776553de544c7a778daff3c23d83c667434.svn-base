...
<form action="" method="post" enctype="multipart/form-data" class="ad_form h_l" id="contribute_sort" name="contribute_sort">
	<ul class="form_ul">
		...
		<li class="i">
			...
			{code}
				$hg_attr['node_en'] = 'contribute_node';
			{/code}
		...
		<li class="i">
			<div class="form_ul_div">
				<span  class="title">限制报料：</span>
				<input  type="checkbox" name="repeat_switch"  value="1"  {if $formdata['repeat_switch']}checked="checked"{/if}/><font style="color: red;" class="important">开启后，此分类下一台设备只能报料一次</font>
			</div>
		</li>
