<li class="clear"  id="r_{$formdata['id']}"    name="{$formdata['id']}"   orderid="{$formdata['order_id']}"  onmouseout="hg_row_interactive(this, 'out');" onmouseover="hg_row_interactive(this, 'on');">
	<span class="left">
		...
		<a class="fb overflow"  style="width:120px;"  id="contribute_sort_name_{$formdata['id']}">{$formdata['sort_name']}</a>
	</span>
	<span class="right" onclick="hg_row_interactive('#r_{$formdata[id]}', 'click', 'cur');"  style="width:239px;">
		<a class="fb" title="编辑" href="javascript:void(0)" onclick="return hg_showAddcontributesort({$formdata['id']})"><em class="b2" ></em></a>
	...
	<span class="title overflow"  style="cursor:pointer;"><a id="contribute_sort_desc_{$formdata['id']}">{$formdata['brief']}</a></span>
</li>