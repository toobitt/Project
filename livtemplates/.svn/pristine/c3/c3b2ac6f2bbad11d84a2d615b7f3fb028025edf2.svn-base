...
<div style="display:none">
	{template:unit/memberstaricon_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6">新增星级样式</a>
	</div>
</div>
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="分组名称">样式名称</div>
             <div class="m2o-item m2o-mark" title="系统样式">系统内置</div>
            <div class="m2o-item m2o-mark" title="星星">星星</div>
            <div class="m2o-item m2o-mark" title="月亮">月亮</div>
            <div class="m2o-item m2o-mark" title="太阳">太阳</div>
        ...
        <div class="m2o-each-list">
        	{if $list}
	        {foreach $list as $k => $v}
	        	{template:unit/memberstariconlist}
	        {/foreach}
	        {else}
...
<script>
$(function(){
	var judgeAfter = function( obj, status ){
