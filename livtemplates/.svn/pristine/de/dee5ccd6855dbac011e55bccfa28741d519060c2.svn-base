			...
			<li class="i">
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						<div>
							{if $pic}
							<img src="{code}echo hg_bulid_img($pic, 50, 50);{/code}" style="vertical-align:middle;" />
							{/if}
				...
				<div class="form_ul_div">
					<div class="col_choose clear">
						...
						<div id="example_box">
							...
							<p><img src="{code}echo hg_bulid_img($v['info'], 50, 50);{/code}" style="vertical-align:middle;" /><span class="dropBtn2" data-id="{$v['id']}">-</span></p>
							{/foreach}
							{/if}
						</div>
						<span class="error" id="logo_tips" style="display:none;"></span>
