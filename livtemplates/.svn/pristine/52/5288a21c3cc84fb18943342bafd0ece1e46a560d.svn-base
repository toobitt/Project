<?php 
/* $Id: report.php 389 2011-07-26 05:33:25Z lijiaying $ */
?>
<style type="text/css">
...
.reportbox_top{background:url(./res/img/Rounded.png) 0 -214px no-repeat;height:16px;font-size:0}
.reportbox_middle{float: left;padding:0 8px;background:url(./res/img/zf_bg.png) repeat-y;width:auto;}
.reportbox_bottom{background: url("./res/img/Rounded.png") no-repeat scroll 0 -231px transparent; float: left; font-size: 0; height: 16px; width: 550px;}
...
.btn_normal,a em{display: inline-block;height: 23px;color: #333;line-height: 23px;font-size: 12px;font-weight: normal;cursor: pointer;text-decoration: none;font-family: "宋体";background: url(./res/img/new_index_bg1.png) no-repeat -320px -100px;}
