...
<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
    <a class="add-button news mr10" href="run.php?mid={$_INPUT['mid']}&a=form&infrm=1" target="formwin">添加商品</a>
</div>
</div>
        ...
        <ul class="common-list news-list">
            <li class="common-list-head public-list-head clear">
                ...
                <div class="common-list-right">
                    <div class="common-list-item  news-fenlei open-close wd70" style="min-width: 70px;">分类</div>
                    <div class="common-list-item  news-fenlei open-close wd100" style="width:300px;">有效期</div>
                    <div class="common-list-item  news-fenlei open-close wd70">已出售</div>
                    <div class="common-list-item news-zhuangtai open-close wd100">状态</div>
