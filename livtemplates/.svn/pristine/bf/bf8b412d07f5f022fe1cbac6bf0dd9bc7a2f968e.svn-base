...
<div style="display:none">
	{template:unit/membergrade_search}
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-mark" title="数字等级">数字等级</div>
            <div class="m2o-item m2o-mark" title="系统内置，禁止删除">系统内置</div>
