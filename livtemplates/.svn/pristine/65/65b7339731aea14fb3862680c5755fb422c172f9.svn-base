...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
   <a class="blue mr10" href="./run.php?mid=527&a=form{$_ext_link}&tbname={$_INPUT['tbname']}" target="nodeFrame">
		<span class="left"></span>
		<span class="middle"><em class="add">新增数据</em></span>
                        ...
                        <li class="common-list-head clear">
                            <div class="common-list-left">
                             ...
                             <div class="common-list-right">
                            	...
                            	<!--
                            	<div class="circle-tjr common-list-item open-close">类别名称</div>
                            	<div class="circle-tjr common-list-item open-close">类别描述</div>
                            	-->
                            </div>                       
                        </li>
                    </ul>
