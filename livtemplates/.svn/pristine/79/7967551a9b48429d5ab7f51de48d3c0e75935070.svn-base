<?php 
/* $Id: head_theme.php 10335 2012-08-03 07:39:28Z repheal $ */
?>
...
<body {$_mBodyCode} class="img_none">
...
<div id = "notify" style="position:relative;clear:both;width:175px; float:right; z-index:9999"><div id='flownotify'></div></div>
	<div class="header">
       <h1><a href="{code} echo hg_build_link('index.php'); {/code}"><img src="./res/img/logo.png"/></a></h1>
    </div>