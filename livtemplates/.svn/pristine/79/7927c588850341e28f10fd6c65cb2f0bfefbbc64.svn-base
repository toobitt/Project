					...
					<div class="col_choose clear">
						...
						<div class="input " style="width:345px;float: left;">
							...
							<span class="input_middle">
								<input type="text" name="zh_name" id="title" size="14" style="width:330px;height: 18px;line-height: 20px;font-size:12px;padding-left:5px;float: left;border:none;" value="{$formdata['zh_name']}"></span>
						</div>
