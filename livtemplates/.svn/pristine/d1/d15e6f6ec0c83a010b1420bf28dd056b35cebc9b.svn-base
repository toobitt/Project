                   ...
                   <ul class="common-list">
                        <li class="common-list-head public-list-head clear">
                            ...
                            <div class="common-list-biaoti">
						        <div class="common-list-item wd120">用户名</div>
                                <div class="common-list-item wd120">本月已使用</div>
                                <div class="common-list-item wd120">充值余额</div>
					        </div>
                        </li>
                    </ul>
	                <ul class="common-list hg_sortable_list public-list" id="auth_form_list">
					    {if $list}
		       			    {foreach  $list  as $k => $v}
		                      {template:unit/app_sms_count_list_item}
		                    {/foreach}
		                {else}
