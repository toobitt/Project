...
{js:underscore} {js:Backbone} {js:jqueryfn/jquery.tmpl.min} {js:ad}
...
<div class="biaoz" style="position: relative; z-index: 1" id="body_content">
	<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']} style="display: none" {/if}>
		<a class="blue mr10"
			href="./run.php?mid={$_INPUT['mid']}&a=form_data{$_ext_link}&cate_id={$_INPUT['cate_id']}&op=create&relation_module_id={$relate_module_id}"
			target="nodeFrame"> <span class="left"></span> <span class="middle"><em
				class="add">新增数据</em> </span> <span class="right"></span>
		</a>
	</div>
				...
				<form method="post" action="" name="listform">
					<ul class="common-list">
						...
						<li class="common-list-head clear">
							...
							<div class="common-list-right">
								...
								<!-- <div class="circle-tjr common-list-item open-close">ID</div> -->
                            	<div class="circle-tjr common-list-item open-close">简介</div>
								<div class="circle-tjr common-list-item open-close">作者</div>
							</div>
							<div class="common-list-biaoti ">
								<div class="common-list-item open-close">标题</div>
							</div>
						</li>
					</ul>
					...
					<ul class="common-list" id="contri_sortlist">
						{if $list && is_array($list)} 
							{foreach $list as $k => $v}
								{template:unit/defaultdata_data_detail} 
							{/foreach} 
						{else}
					...
					<ul class="common-list">
						<li class="common-list-bottom clear">
							<div class="common-list-left"></div> {$pagelink}
						</li>
					</ul>
				</form>
			</div>
