...
function put_queue(id)
{
	  $.get("./run.php?mid=" + gMid + "&a=user_put_queue&admin_id=" + gAdmin.admin_id + "&admin_pass=" + gAdmin.admin_pass,{id:id},
				...
				if(obj[0].error)
				{
					...
					setTimeout("back('获取微博',"+obj[0].id+")",5000);
				}
				else
				{
					$("#queue_" + id).html("正在获取...");
...
<a href="./run.php?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6" style="font-weight:bold;">添加用户</a>
</div>
               ...
               <ul class="common-list">
                    <li class="common-list-head clear">
                        ...
                        <div class="common-list-right">
                            ...
                            <div class="common-list-item open-close">微博类型</div>                       
                        	<div class="common-list-item open-close">所属圈子</div>
                            <div class="common-list-item open-close">状态</div>
                            <div class="common-list-item open-close" >操作</div>
                            <div class="common-list-item" style="width:100px;">添加人/添加时间</div>
                        </div>
                        <div class="common-list-biaoti">
					        <div class="common-list-item open-close">用户昵称</div>
				        </div>
                    </li>
                </ul>           
...
<script type="text/javascript">
	...
	function hg_getweibo_call(id)
	{
		 var ids=id.split(",");
		 for(var i=0;i<ids.length;i++)
		 {
			$("#queue_"+ids[i]).html("获取完成");
		 }
	}
</script>
{template:foot}