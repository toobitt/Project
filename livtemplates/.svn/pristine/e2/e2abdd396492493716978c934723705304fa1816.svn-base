    ...
    $.widget('video.file', {
        ...
        _listAjax : function(empty){
            ...
            $.getJSON(
                ...
                function(json){
                    ...
                    if( _this.options.type == 'video'){							/*直播不需要分页*/
        ...
        _listFilter : function(json){
            ...
            $.each(json, function(i, n){
                list.push({
                    id : n.id,
                    src : n.img ? n.img : n.logo_rectangle_url,
                    video_src : n.channel_stream && n.channel_stream[0].live_m3u8,
                    title : n.title,
                    name : n.name,
                    duration : n.duration ? n.duration : '直播',
                    type : n.channel_stream ? 1 : 0,							/*判断是否显示拆条数*/
