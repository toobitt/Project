...
<div style="display:none">
	...
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6">新增我的模块</a>
	</div>
</div>
<!-- 记录列表 -->
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="图标/名称">图标/模块名称</div>
          <!--    <div class="m2o-item m2o-mark" title="是否系统">是否系统</div> -->
            <div class="m2o-item m2o-mark" title="标识">模块标识</div>
            <div class="m2o-item m2o-mark" title="定义字段数量">自定义字段数</div>
            <div class="m2o-item m2o-mark" title="使用源">使用源</div>
            <div class="m2o-item m2o-url" title="模块链接">模块链接</div>
            <div class="m2o-item m2o-switch" title="是否在显示">显示</div>
