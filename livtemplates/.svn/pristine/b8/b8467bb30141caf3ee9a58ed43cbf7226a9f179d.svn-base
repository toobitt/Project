...
<div id="hg_page_menu" class="head_op_program" {if $_INPUT['infrm']}style="display:none"{/if}>
	<a class="blue mr10" href="?mid={$_INPUT['mid']}&a=form{$_ext_link}">
		...
		<span class="middle"><em class="add">新增企业</em></span>
				...
				<form name="searchform" id="searchform" action="" method="get" onsubmit="return hg_del_keywords();">
					<div class="select-search">
						{code}
							...
							if (!$_INPUT['t_id']) $_INPUT['t_id'] = -1;
							if (!$_INPUT['g_id']) $_INPUT['g_id'] = -1;
						...
						{template:form/search_source,t_id,$_INPUT['t_id'],$trade_info,$attr_trade}
						{template:form/search_source,g_id,$_INPUT['g_id'],$grade_info,$attr_grade}
                    ...
                    <ul class="common-list">
                        <li class="common-list-head clear">
                            ...
                            <div class="common-list-right">
                            	<div class="group-tz common-list-item open-close" style="padding-right: 10px;">操作</div>
                            	<div class="group-cz common-list-item open-close">所属行业</div>
                            	<div class="group-tz common-list-item open-close">权限等级</div>
                            	<div class="group-cz2 common-list-item open-close">地址</div>
                                <div class="group-cz common-list-item open-close" style="padding-right: 5px;">创建时间</div>
                            </div>
                            <div class="common-list-biaoti">
						        <div class="common-list-item open-close group-title">企业名称</div>
					        </div>
                        </li>
                    </ul>
