...
<div style="display:none">
	{template:unit/congfigApp_search}
	<div class="controll-area fr mt5" id="hg_page_menu" style="display:none">
		<a href="?mid={$_INPUT['mid']}&a=form{$_ext_link}" class="button_6">新增配置应用</a>
	</div>
</div>
...
<div class="common-list-content" style="min-height:auto;min-width:auto;">
	<form action="" method="post">
	 <div class="m2o-list">
            ...
            <div class="m2o-item m2o-flex-one m2o-bt" title="名称">应用名称</div>
            <div class="m2o-item m2o-mark" title="标识">应用标识</div>
            <div class="m2o-item m2o-brief" title="标识">描述</div>  
