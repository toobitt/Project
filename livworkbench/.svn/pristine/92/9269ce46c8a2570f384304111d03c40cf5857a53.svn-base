...
LotteryDisc.prototype.setUesrAward = function( i ){
	this.userAwardsIndex = i;
	this.angelOffset = Math.random()*( this.eachDegree - 5 );	//设一个随机的偏移量
};
...
LotteryDisc.prototype.spin = function() { 
	...
	this.startAngle = Math.PI/180 * ( 100 - this.userAwardsIndex * this.eachDegree - this.angelOffset);
	this.rotateWheel();
}
...
LotteryDisc.prototype.finish = function(){
