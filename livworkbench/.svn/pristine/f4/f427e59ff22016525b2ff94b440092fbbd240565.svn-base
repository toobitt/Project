  ...
  /*** /icons related ***/
    ...
    */
    ...
    this.insert_pic=function(src)
    {
    	  ...
    	  oUtil.oEditor.document.execCommand("InsertImage", false, src);
    }
    return this;
    }
  ...
  if(this.mode=="XHTML"){this.btnXHTMLFullSource=true;this.btnXHTMLSource=false;}
	...
	if(!InnovaEditor.new2012){
		sHTML+="<table id=idArea"+this.oName+" name=idArea"+this.oName+" border='0px' "+
				...
				"<tr><td colspan=2 style=\"padding:0px;padding-left:1px;border:#cfcfcf 0px solid;background:url('"+this.scriptPath+"bg.gif')\">"+
		...
		sHTML+="<iframe class=\"each-editor-iframe\" style=\"width:"+ (this.width - 2) +"px;height:"+ (this.height - 32) +"px;\" frameborder=\"0\" name=idContent"+ this.oName + " id=idContent"+this.oName+ "></iframe>";

		sHTML+="<iframe style='width:1px;height:1px;overflow:auto;border:0px;display:none;' id=\"myStyle"+this.oName+"\" name=\"myStyle"+this.oName+"\" src='"+this.scriptPath+"blank.gif'></iframe>";
