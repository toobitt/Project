...
<div class="drawer_login right-column">
<div class="drawer_login-wrap">
<div class="head">
	<div class="head-area">
...
<section>
	<ul class="list">
		<li class="collect">
			<a class="anchor" href="#"><img src="../../lib/images/personal/icon_phone_gray.png" /><span>绑定手机号</span></a>
	...
	<ul class="list">
		...
		<li class="recommend">
			<a class="anchor" href="#"><img src="../../lib/images/personal/icon_score.png" /><span>给我们评分</span></a>
			<div class="config next"><a class="anchor-next" href="#"></a></div>
		</li>
		<li class="recommend">
