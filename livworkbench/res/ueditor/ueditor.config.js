...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
                    ['source', '|', 'undo', 'redo', '|',
                        'bold', 'italic', 'underline','removetag', 'indent',  'forecolor', '|',  'fontsize', 'insertorderedlist', 
                        'justifyleft', 'justifycenter', 'justifyright', '|',
                         'imgmanage' , 'attach' , 'water','imglocal', 'refer' , 'm2o_pagebreak', 'm2o_auto_pagebreak', 'pizhu','office']
                ]
    	,contextMenu : []
    	/*, toolbars:[
                    ['source', '|', 'undo', 'redo', '|',
                        'bold', 'italic', 'underline', 'forecolor', 'cleardoc', 'autotypeset', 'removeformat', 'searchreplace', '|',  'fontsize', 'insertorderedlist', 'insertunorderedlist',
                        'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                         'imgmanage' , 'attach' , 'water', 'refer' , 'm2o_pagebreak', 'm2o_auto_pagebreak', 'pizhu']
                ]*/
        /*, toolbars:[
